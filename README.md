...
| `apps/guide/` | Field Guide PWA at `guide.thetalusfieldjournal.com` (the `talus-field-guide.pages.dev` host keeps resolving alongside it). Buyer-only, offline-capable. | Vite + React 19 + TypeScript + react-router-dom + zod. |
