...
| `Header`, `Footer`, `BottomNav`, `BackToTop`, `Breadcrumbs`, `KeepGoing`, `ArticleCard`, `NewsletterInline`, `ExitIntentNewsletter`, `Placeholder`, `ResponsiveImage`, `MapLightbox`, `ShareRow`, `AffiliateNote`, `AvailabilityLink`, `LodgingCta`, `ExpediaBanner`, `expediaSearchUrl`, `EntranceWaits`, `WebcamStrip`, `GuidePromo`, `MotifMountains`, `MotifSun`, `MotifTrees` | components.jsx | Shared components (implicit globals). |
