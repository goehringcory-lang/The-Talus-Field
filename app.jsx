...
function buildSeo(route) {
  ...
  const known = {
    ...
    stay: {
      ...
      description:
        "Every place to sleep in and around Yosemite, compared honestly: the in-park lodges and camps, the four road corridors with their gateway towns and named lodges, which corridor fits which season, and how the 366-day booking window actually works.",
      ogType: "website",
