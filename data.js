...
window.BODY_VERSIONS = {
  ...
  "mariposa-grove-how-to-visit": 2,
  "tuolumne-meadows-in-a-day": 3,
  "swimming-in-the-merced": 2,
  ...
  "yosemite-connecting-to-traditions": 2,
  "yosemite-waterfalls-guide": 4,
  "yosemite-photography-spots": 3,
  "horsetail-fall-firefall": 3,
  ...
  "pets-in-yosemite": 5,
  "yosemite-ranger-programs": 4,
  "yosemite-camping-complete-guide": 10,
  "where-to-propose-in-yosemite": 2,
  "is-bear-spray-allowed-in-yosemite": 2,
  "yosemite-bears-safety-guide": 119,
  "yosemite-heat-safety-guide": 5,
  "when-to-visit-yosemite-2026-crowd-forecast": 4,
  "yosemite-trip-cost-budget-2026": 9,
  "yosemite-in-september-2026": 1,
  "yosemite-in-june-2026": 4,
  "cathedral-lakes-day-hike": 2,
  "yosemite-needs-a-reservation-system": 80,
  "memorial-day-skip-the-valley-go-high-2026": 82,
  "four-mile-up-panorama-down": 78,
  "yosemite-with-kids-no-reservations-2026": 79,
  "tioga-road-opening-weekend-2026": 78,
  "so-you-want-to-hike-half-dome": 78,
  "glacier-point-road-open-2026": 81,
  "mist-trail-the-real-guide": 86,
  "first-time-yosemite-overwhelm": 87,
  "yosemite-without-reservations-2026": 85,
  "yosemite-during-smoke-season": 76,
  "yosemite-gateway-towns-compared": 96,
  "pack-your-car-for-yosemite": 84,
  "yosemite-for-non-hikers": 81,
  "yosemite-stargazing-where-to-look-up": 79,
  "hetch-hetchy-the-other-yosemite-valley": 78,
  "what-is-a-talus-field": 2,
  "yosemite-glaciers-climate": 78,
  "giant-sequoias-fire-adaptation": 76,
  "bears-spring-emergence": 77,
  "water-ouzels-waterfalls": 77,
  "working-in-yosemite": 77,
  "yosemite-in-one-or-two-days": 87,
  "where-to-eat-yosemite": 85,
  "yosemite-in-march": 3,
};
...
window.ARTICLES = [
  ...
  },
  {
    ...
    cat: "planning",
    title: "Glacier Point: How to Visit and When the Road Is Open",
  ...
  },
  {
    ...
    read: "11 min",
    placeholder: "Automobiles lined up at the Yosemite Valley Railroad's El Portal terminal in the 1920s",
    image: "img/el-portal-yosemite-valley-railroad-cars.jpg",
    credit: "Photo: Yosemite Park & Curry Company / Wikimedia Commons (public domain)",
  },
  {
    slug: "yosemite-facelift-volunteer-guide",
    cat: "planning",
    title: "Yosemite Facelift: How to Volunteer for the Park Cleanup",
  ...
  },
  {
    ...
    cat: "planning",
    title: "Yosemite fire restrictions: what's banned, what still works",
  ...
  },
  {
    ...
    read: "12 min",
    placeholder: "El Capitan in last light above the Merced River, snow still on the banks",
    image: "img/el-capitan-snow-spring.jpg",
    credit: "Photo: Anita Ritenour / Wikimedia Commons (CC BY 2.0)",
  },
  {
  ...
  },
  {
    ...
    cat: "trails",
    title: "First Yosemite Backpacking Trip: What the Permit Doesn't Say",
  ...
  },
  {
    ...
    cat: "seasonal",
    title: "Swimming in Yosemite: Where to Get in the Merced River",
  ...
  },
  {
    ...
    cat: "planning",
    title: "Tuolumne Meadows in a day: a Yosemite high-country plan",
  ...
  },
  {
    ...
    cat: "planning",
    title: "Mariposa Grove: how to visit Yosemite's giant sequoias",
  ...
  },
  {
    ...
    cat: "planning",
    title: "Yosemite Valley Parking: Where to Park and When Lots Fill",
  ...
  },
  {
    ...
    cat: "planning",
    title: "Yosemite Shuttle and YARTS: When Each Bus Beats Driving",
  ...
  },
  {
    ...
    cat: "wildlife",
    title: "Yosemite tunnel trees: the sequoia measured to the half inch",
    ...
    read: "8 min",
    placeholder: "A horse-drawn wagon standing inside the tunnel cut through the Wawona Tree",
    image: "img/wawona-tunnel-tree-stagecoach.jpg",
    credit: "Photo: Brickey, E.M. / Wikimedia Commons (public domain)",
  },
  {
    slug: "yosemite-wildlife-viewing-guide",
    cat: "wildlife",
    title: "Yosemite Wildlife: What Lives Here, and Where to See It",
  ...
  },
  {
    ...
    cat: "wildlife",
    title: "Showy milkweed in Yosemite Valley: the monarchs depend on it",
  ...
  },
  {
    ...
    cat: "seasonal",
    title: "Connecting to Traditions: Meet Yosemite's Indigenous Artists",
  ...
  },
  {
    ...
    image: "img/upper-yosemite-fall-spring-flow.jpg",
    credit: "Photo: Micah Bochart / Wikimedia Commons (public domain)",
  },
  {
    slug: "yosemite-photography-spots",
    cat: "planning",
    title: "Yosemite Photography Spots: The Light, and When to Be There",
  ...
  },
  {
    ...
    cat: "seasonal",
    title: "Yosemite Firefall: How Horsetail Fall Works in February",
  ...
  },
  {
    ...
    isoModified: "2026-09-09",
    read: "8 min",
    placeholder: "Half Dome above a snow-covered Yosemite Valley in a George Fiske photograph",
    image: "img/half-dome-winter-snow.jpg",
  ...
  },
  {
    ...
    cat: "wildlife",
    title: "Yosemite Wildflowers: The Bloom Calendar Climbs the Mountain",
    ...
    isoModified: "2026-07-12",
    read: "7 min",
    placeholder: "Deer brush in full white bloom on a Yosemite hillside recovering from fire",
    image: "img/yosemite-ceanothus-bloom.jpg",
    credit: "Photo: Dawn Endico / Wikimedia Commons (CC BY-SA 2.0)",
  },
  {
    slug: "watching-climbers-el-capitan",
    cat: "planning",
    title: "Watching Climbers on El Capitan: A Spectator's Guide",
  ...
  },
  {
    ...
    cat: "planning",
    title: "Yosemite Wilderness Permits, Explained",
    ...
    isoModified: "2026-08-07",
    read: "6 min",
    placeholder: "Lyell Canyon from the John Muir Trail, the Lyell Fork winding through its meadows",
    image: "img/john-muir-trail-backpacker-yosemite.jpg",
    credit: "Photo: Kaitymh / Wikimedia Commons (CC BY-SA 4.0)",
  },
  {
    ...
    read: "6 min",
    placeholder: "Lower Yosemite Fall at spring flow above the paved loop trail",
  ...
  },
  {
    ...
    cat: "planning",
    title: "Yosemite Ranger Programs: The Best Thing in the Park Is Free",
    ...
    read: "5 min",
    placeholder: "A ranger-led walk in Tuolumne Meadows with Lembert Dome behind, from the NPS archive",
    image: "img/yosemite-ranger-program-visitors.jpg",
    credit: "Photo: Richard Frear / Wikimedia Commons (public domain)",
  },
  {
  ...
  },
  {
    ...
    isoModified: "2026-08-25",
    read: "5 min",
    placeholder: "A cinnamon-phase black bear crossing a fallen log in a Yosemite forest",
    image: "img/black-bear-yosemite-forest.jpg",
    credit: "Photo: Pavel Špindler / Wikimedia Commons (CC BY 3.0)",
  },
  {
    slug: "yosemite-bears-safety-guide",
    cat: "wildlife",
    title: "Yosemite Bear Safety: What to Do When You See a Bear",
  ...
  },
  {
    ...
    isoModified: "2026-08-01",
    read: "10 min",
    placeholder: "The entrance of Yosemite Valley Lodge at dusk",
  ...
  },
  {
    ...
    cat: "seasonal",
    title: "Yosemite in September 2026: What Closes, What Gets Better",
  ...
  },
  {
    ...
    cat: "trails",
    title: "Cathedral Lakes hike: the high-country day worth the drive",
  ...
  },
  {
    ...
    dek: "Where the food actually is, area by area: the Valley's eleven counters and dining rooms, the seasonal kitchens on Tioga Road, the gateway towns worth the drive, and a complete roster of everything open around Mariposa.",
    seoDek: "Restaurants in Yosemite Valley, Wawona, Fish Camp and the gateway towns, plus every place open around Mariposa in August 2026. From a resident who eats in them.",
    date: "May 19, 2026",
    isoDate: "2026-05-19",
    isoModified: "2026-08-28",
    read: "14 min",
  ...
  },
  {
    ...
    isoModified: "2026-09-09",
    read: "11 min",
    placeholder: "Lembert Dome over Tuolumne Meadows at sunset",
  ...
  },
  {
    ...
    cat: "trails",
    title: "Hiking Half Dome: what it takes, and the better alternative",
    ...
    read: "17 min",
    placeholder: "Half Dome above the Merced River from the Valley floor in spring",
    image: "img/half-dome-merced-river-spring.jpg",
    credit: "Photo: Dexter Perkins / Wikimedia Commons (CC0)",
  },
  {
  ...
  },
  {
    ...
    cat: "planning",
    title: "Working in Yosemite: so you want a job in the park",
  ...
  },
  {
    ...
    cat: "wildlife",
    title: "Water ouzels: how the American dipper lives in a waterfall",
  ...
  },
  {
    ...
    cat: "wildlife",
    title: "Why a Yosemite bear in April is more dangerous than in August",
    ...
    isoModified: "2026-05-08",
    read: "8 min",
    placeholder: "A cinnamon-phase black bear foraging in a green Yosemite meadow",
    image: "img/black-bear-yosemite-meadow.jpg",
    credit: "Photo: Pavel Špindler / Wikimedia Commons (CC BY 3.0)",
  },
  {
  ...
  },
  {
    ...
    read: "10 min",
    placeholder: "Kolana Rock above Hetch Hetchy Reservoir from the trail beyond the dam",
    image: "img/hetch-hetchy-reservoir-kolana-rock.jpg",
  ...
  },
  {
    ...
    read: "12 min",
    placeholder: "Middle Cathedral Rock and the Cathedral Spires across Yosemite Valley",
    image: "img/cathedral-rocks-middle-cathedral.jpg",
    credit: "Photo: OMCV / Wikimedia Commons (public domain)",
  },
  {
...
//
// It read five until September 2026 while validateRelated (gen-seo-artifacts.mjs)
// accepted four to six, so the 22 lists curated at six quietly shipped five: the
// sixth slug was validated, then truncated by relatedFor and rendered nowhere,
// in the rail, the crawler block or articles.json. The two numbers have to
// agree, and the ceiling is the one that was curated and reviewed.
window.RELATED_COUNT = 6;
