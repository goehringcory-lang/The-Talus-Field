...
window.ARTICLE_BODIES["yosemite-gateway-towns-compared"] = function YosemiteGatewayTownsComparedBody() {
  return React.createElement(React.Fragment, null, React.createElement("p", {
    ...
    href: "/distances"
  }, "the drive times page"), "."), React.createElement("h2", {
    id: "sec-closest-town-to-yosemite-by-entrance"
  }, "The closest town to Yosemite, by entrance"), React.createElement("p", null, "\"Closest town to Yosemite\" has four answers. The park has four through-road entrances, and the closest town to one is two hours from another. The better question is what's closest to the place you're actually going:"), React.createElement("ul", null, React.createElement("li", null, React.createElement("strong", null, "Closest town to Yosemite Valley:"), " El Portal, about 14 miles and 25 to 35 minutes on Highway 140, through the Arch Rock entrance. Mariposa is next at about 45 miles. Foresta, inside the boundary, has a handful of rental cabins and nothing else."), React.createElement("li", null, React.createElement("strong", null, "Closest town to the South Entrance:"), " Fish Camp, two miles from the gate, with Tenaya Lodge and a few inns; Oakhurst, about 14 miles and 20 to 25 minutes, is the closest full town. The Mariposa Grove is just inside this gate and Wawona six miles beyond it."), React.createElement("li", null, React.createElement("strong", null, "Closest town to the Big Oak Flat Entrance (the west, from the Bay Area):"), " Buck Meadows and the Highway 120 lodges, a few minutes from the gate; Groveland, about 24 miles and 30 to 40 minutes, is the closest town with a main street."), React.createElement("li", null, React.createElement("strong", null, "Closest town to Tioga Pass (the east):"), " Lee Vining, about a dozen miles down Highway 120 East, summer only. When the pass is closed there is no town near this entrance because there is no entrance."), React.createElement("li", null, React.createElement("strong", null, "Closest city with an airport:"), " Fresno, about 65 miles from the South Entrance and 94 from the Valley by the Park Service's count, with summer YARTS service up Highway 41. Merced, on Highway 140, is the year-round YARTS hub for the Valley.")), React.createElement("p", null, "If you'd rather have the answer before the detail, it's one of these five:"), React.createElement("ul", null, React.createElement("li", null, React.createElement("strong", null, "El Portal"), " if the drive is the thing to shorten: first light in the Valley, or a winter trip on the lowest, most reliable road."), React.createElement("li", null, React.createElement("strong", null, "Mariposa"), " if you want a real town at the end of the day, more than one price point, and a year-round road. The default answer for a first trip."), React.createElement("li", null, React.createElement("strong", null, "Groveland"), " if you are coming from the Bay Area, want a smaller and cheaper town with more character than Oakhurst, or Hetch Hetchy is on the list."), React.createElement("li", null, React.createElement("strong", null, "Oakhurst"), " if the Mariposa Grove and Wawona are the point, you are driving up from Los Angeles or Fresno, or you want predictable chain lodging and a full-size supermarket."), React.createElement("li", null, React.createElement("strong", null, "Lee Vining"), " if Tioga Road is open and the high country is the trip. It isn't a Valley base, and treating it like one is the most common mistake on this list.")), React.createElement(TownPicker, null), React.createElement("p", null, "Now the towns themselves."), React.createElement("h2", {
    id: "sec-1-el-portal"
    ...
    motif: React.createElement(MotifMountains, null)
  }), React.createElement("p", null, "Oakhurst is the biggest gateway by population and amenities, with more chain lodging and chain dining than the other four combined. It feels like a regular Central California town that happens to be near a national park, not a town that exists because of one."), React.createElement("p", null, "Why people pick it:"), React.createElement("ul", null, React.createElement("li", null, "Fast access to Wawona and the Mariposa Grove of giant sequoias."), React.createElement("li", null, "Predictable chain rooms at predictable prices, bookable late."), React.createElement("li", null, "The widest range of standard amenities of any gateway: chain supermarkets, national pharmacies, urgent care. The easiest of the five towns to fill a prescription or replace forgotten gear in.")), React.createElement("p", null, "Why they regret it:"), React.createElement("ul", null, React.createElement("li", null, "The longest Valley drive of any gateway. At 75 to 90 minutes each way, a Valley day means three hours in the car, and people shrug it off until about the third morning."), React.createElement("li", null, "Less character than Mariposa or Groveland, if the gateway-town atmosphere is part of your trip."), React.createElement("li", null, "Highway 41 climbs over a ridge and descends into Wawona before reaching the Valley: longer and more winding than 140.")), React.createElement("p", null, React.createElement("strong", null, "The closer option on this corridor:"), " Fish Camp, twelve miles up the road at the park line, puts you four minutes from the South Entrance. It is ", React.createElement("strong", null, "Tenaya Lodge at Yosemite"), ", a full resort on 75 acres two miles from the gate, plus a few small inns, all at resort prices, trading Oakhurst's services for the setting."), React.createElement("p", null, React.createElement("strong", null, "Pick Oakhurst"), " if the itinerary centers on the Mariposa Grove and Wawona, if you want chain predictability, or if you are driving up from Los Angeles or Fresno, since it sits on the natural path. ", React.createElement("strong", null, "Skip it"), " if this is really a Yosemite Valley trip. Three hours a day in the car is what it costs you."), townAvailability("Oakhurst", "Oakhurst, California"), React.createElement("p", null, "One current note for this side of the park: the Wawona Hotel, the historic in-park option just inside the South Entrance, has been closed since December 2024, and the Park Service has said it stays closed for this visitor season to complete a condition assessment of the hotel complex after a roof project turned up structural concerns. No reopening date has been announced. That removes the in-park alternative on the Highway 41 corridor and puts more pressure on Oakhurst and Fish Camp rooms in summer. Book earlier than you think you'll need to."), React.createElement("h2", {
    id: "sec-4-groveland"
  }, "Groveland"), React.createElement(TownFacts, {
    rows: [["Valley drive", "about 48 miles, 65 to 80 minutes"], ["Entrance", "Big Oak Flat, about 24 miles, 30 to 40 winding minutes"], ["Road", "Highway 120, chain controls common in winter"], ["Elevation", "about 3,100 feet, the highest of the western gateways"], ["The town", "a small historic gold-rush main street with strong personality"]]
  }), React.createElement("p", null, "Groveland is the gateway people overlook, and they shouldn't: a historic main street with the ", React.createElement("strong", null, "Groveland Hotel"), ", the ", React.createElement("strong", null, "Iron Door Saloon"), " (one of the oldest continuously operating saloons in California), and the kind of small-town character Mariposa has, at a smaller scale and with a different flavor."), React.createElement("p", null, "Why people pick it:"), React.createElement("ul", null, React.createElement("li", null, "A town that's worth an evening on its own. The Iron Door is a reason to go."), React.createElement("li", null, "Less crowded and often cheaper than Mariposa or El Portal, with easier last-minute rooms in shoulder seasons."), React.createElement("li", null, "The best position for Hetch Hetchy, the Tuolumne side of the park, and Tuolumne Meadows when Tioga Road is open.")), React.createElement("p", null, "Why they regret it:"), React.createElement("ul", null, React.createElement("li", null, "The drive to the Valley starts a thousand feet higher than the 140 towns, and chain controls are common in winter."), React.createElement("li", null, "The route passes through the 2013 Rim Fire burn scar, recovering but still visually different from the Highway 140 approach."), React.createElement("li", null, "Fewer total lodging options than Mariposa, and a town that closes early.")), React.createElement("p", null, React.createElement("strong", null, "Services:"), " a market rather than a supermarket, gas, and that's about it. Groveland is the last town of any size on Highway 120 before the entrance; the nearest in-park pumps are at Crane Flat. Fill the tank and the cooler here, or in Oakdale or Sonora on the way in from the Bay Area, before you start climbing."), React.createElement("p", null, React.createElement("strong", null, "The closer options on this corridor:"), " the largest lodges on this side are not in Groveland itself but strung along Highway 120 east of it, which is a meaningful difference on a Valley morning. ", React.createElement("strong", null, "Rush Creek Lodge"), " sits on twenty wooded acres roughly half a mile from the Big Oak Flat entrance. Its sister property, the historic ", React.createElement("strong", null, "Evergreen Lodge"), ", is about seven miles on, down Evergreen Road toward Hetch Hetchy, which makes it the closest bed to that corner of the park. ", React.createElement("strong", null, "Firefall Ranch"), ", cottages and villas on a former stagecoach stop between Groveland and the gate, is the newest of the three. All three are priced well above a Groveland motel and book like it."), React.createElement("p", null, React.createElement("strong", null, "If Hetch Hetchy is your reason:"), " the road in is open daylight hours only, so don't plan on sunset there, and vehicles over 25 feet aren't allowed on it. From November through March it can close entirely or require chains, which is exactly when a low-elevation reservoir hike sounds best. Check before you commit a day to it."), React.createElement("p", null, React.createElement("strong", null, "Pick Groveland"), " for gateway-town character, for Hetch Hetchy and the northern park, or as the natural base on the route from the Bay Area. ", React.createElement("strong", null, "Skip it"), " for a deep-winter trip without snow-driving experience or chains in the trunk, or if you'll need real services at nine at night."), townAvailability("Groveland", "Groveland, California"), React.createElement("h2", {
    id: "sec-5-lee-vining"
    ...
    id: "sec-where-to-stay-near-yosemite-with-kids"
  }, "Where to stay near Yosemite with kids"), React.createElement("p", null, "Mariposa, for most families, and Oakhurst if the sequoias are the point of the trip. The reasoning is the same as the general case with the volume turned up: a family needs a full supermarket, a pharmacy, more than one dinner option, and a room that can be booked late, and Mariposa and Oakhurst are the only two gateways that have all four. Mariposa wins on the Valley drive, which matters more with children who have a limit on car time, and on the year-round road. El Portal's short drive is a real advantage for early starts with small kids, if you can get a room and do not mind driving to Mariposa for dinner. Groveland's main street is charming for adults and thin on the things that rescue a family evening. ", React.createElement("a", {
    href: "/articles/yosemite-with-kids-no-reservations-2026"
  }, "Yosemite with kids"), " has the in-park half: which walks, which shuttle stops, and where the bathrooms are."), React.createElement("h2", {
    id: "sec-yosemite-and-sequoia-in-one-trip"
  }, "Yosemite and Sequoia in one trip"), React.createElement("p", null, "Base south. Oakhurst is the pivot between the two parks: the South Entrance is 20 to 25 minutes north on Highway 41, and Fresno, then Highway 180 to the Kings Canyon entrance and the Generals Highway into Sequoia, is roughly two to two and a half hours south. Doing both from Mariposa or Groveland adds an hour to every leg. The usual shape is two nights in Oakhurst for Yosemite (one Valley day, one Mariposa Grove and Wawona day), then a drive to Three Rivers or the Kings Canyon side for the second park. Don't try Sequoia as a day trip from any Yosemite gateway. The round trip is five hours of driving before you've seen a single tree."), React.createElement("h2", {
    id: "sec-common-questions"
  }, "Common questions"), React.createElement("p", null, React.createElement("strong", null, "What is the closest town to Yosemite?"), " El Portal, about 14 miles and 25 to 35 minutes from Yosemite Valley on Highway 140. For the South Entrance and the Mariposa Grove it is Fish Camp, then Oakhurst; for the Big Oak Flat Entrance it is Groveland; for Tioga Pass, in summer, Lee Vining."), React.createElement("p", null, React.createElement("strong", null, "What is the best town to stay in near Yosemite?"), " For most first-time visitors, Mariposa: a real town, several price points, full supermarkets, and the year-round Highway 140 road at 45 to 60 minutes from the Valley. El Portal if the drive is the thing to shorten, Oakhurst for the sequoias, Groveland for character and the Bay Area route, Lee Vining for the high country."), React.createElement("p", null, React.createElement("strong", null, "Is Oakhurst or Mariposa closer to Yosemite Valley?"), " Mariposa, by 30 minutes or more: 45 to 60 minutes on Highway 140 against 75 to 90 on Highway 41. Oakhurst is closer to the South Entrance and the Mariposa Grove, 20 to 25 minutes."), React.createElement("p", null, React.createElement("strong", null, "Where should I stay near the Yosemite south entrance?"), " Fish Camp, two miles from the gate, if you want to be closest; Oakhurst, 14 miles, if you want a full town. The Wawona Hotel, the in-park option on this side, has been closed since December 2024."), React.createElement("p", null, React.createElement("strong", null, "Where should I stay near Yosemite with kids?"), " Mariposa for a Valley trip, Oakhurst for a sequoia trip. Both have full supermarkets, pharmacies, several restaurants, and rooms that can be booked later than El Portal or the in-park lodges."), React.createElement("p", null, React.createElement("strong", null, "Which gateway town is cheapest?"), " Groveland and Mariposa typically have the widest range and the most budget rooms. El Portal is priced like in-park lodging. Oakhurst has predictable chain prices. Lee Vining has little inventory and prices accordingly."), React.createElement("p", null, React.createElement("strong", null, "Which towns have full grocery stores?"), " Mariposa and Oakhurst. Groveland has a market. El Portal and Lee Vining have convenience-scale markets only."), React.createElement("p", null, React.createElement("strong", null, "Which town works in winter?"), " El Portal or Mariposa, on Highway 140, the lowest and most reliable road. Groveland works with chains. Lee Vining has no road into the park at all when Tioga Pass is closed."), React.createElement("h2", {
    id: "sec-9-the-takeaway"
  }, "The takeaway"), React.createElement("p", null, "The right gateway town comes down to your trip, not to which town has the best reviews. Mariposa is the safest first-timer's choice. El Portal is the strongest if you can get a room. Groveland is the underrated pick for character without the crowd. Oakhurst is for the southern-entrance trip. Lee Vining is the east-side experience that most western visitors never see."), React.createElement("p", null, "So pick based on where your trip's weight sits. Mostly Yosemite Valley? Base in the west. Mostly the high country? Look east. The giant sequoias? Go south. That's the whole decision. Make it once, make it well, and the rest of the trip gets easier."), React.createElement("p", null, "If you're still working out how to approach the park, start with the ", React.createElement("a", {
