...
function GuideOfflineDemo() {
  ...
  return React.createElement("div", {
    ...
    className: "eyebrow"
  }, "Needs signal"), React.createElement("ul", null, React.createElement("li", null, "· The live park webcams"), React.createElement("li", null, "· Entrance waits and parking-lot status right now"), React.createElement("li", null, "· Campsite-opening alerts, which run on the guide's server and arrive by push or email"), React.createElement("li", null, "· Fresh weather and program updates (the last sync stays readable)"), React.createElement("li", null, "· The Nature Notes archive links back to this site")))), React.createElement("p", {
