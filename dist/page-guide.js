...
function GuideBuyBox() {
  ...
  }, "Payment received. Your access code and sign-in link are on their way to your email. Check spam if nothing arrives in a few minutes."), outcome === "cancel" && React.createElement("p", {
    style: {
      fontFamily: "var(--sans)",
      fontSize: 14,
      color: "var(--ink-2)",
  ...
  }, busy ? "Opening checkout…" : "Buy the guide → $9"), error && React.createElement("p", {
    style: {
      fontFamily: "var(--sans)",
      fontSize: 13,
      color: "var(--moss)",
  ...
  }, "One payment. The app, every photo, and the offline park map are yours for 18 months on every device you own. Updates push automatically through the 2026 season, including the Secret Spots section as it lands."), React.createElement("p", {
    style: {
      fontFamily: "var(--sans)",
      fontSize: 12,
      color: "var(--ink-3)",
  ...
  }, React.createElement("li", null, "· Three regional guides: the Valley, Glacier Point & Mariposa, Tuolumne"), React.createElement("li", null, "· Tappable GPS for every stop"), React.createElement("li", null, "· An offline topo map of the park, all stops pinned"), React.createElement("li", null, "· Download the whole guide for offline, about 45 MB"), React.createElement("li", null, "· Time budgets and a swap for when the lot is full"), React.createElement("li", null, "· Know-before-you-go essentials and a packing checklist you check off in-app"), React.createElement("li", null, "· Search across everything"), React.createElement("li", null, "· Secret Spots: coming soon, included with purchase"))), React.createElement("div", {
    style: {
      borderTop: "1px solid var(--rule)",
      marginTop: 24,
      paddingTop: 20
...
function GuidePage({
  ...
  }, "A web app you add to your home screen. Three regional guides with tappable GPS, time budgets, a swap for when the plan dies, and an offline topo map of the whole park. Works at the trailhead when service doesn't. Not a PDF. Not another tourist checklist."))), React.createElement("div", {
    className: "wrap",
    style: {
      paddingTop: 24,
      paddingBottom: 80
