...
window.ARTICLE_BODIES["getting-to-yosemite"] = function GettingToYosemiteBody() {
  return (
    <>
      <p className="dropcap">
      ...
      <Placeholder
        caption="Highway 140 climbing the Merced River canyon toward Arch Rock, the all-weather road into the Valley"
      ...
      <ol>
        <li>Valley-focused trip, or any trip November through March: Highway 140 through Mariposa.</li>
        <li>High country, Hetch Hetchy, or coming from the Bay Area with time: Highway 120 through Groveland.</li>
        <li>Flying into Fresno, or Mariposa Grove first: Highway 41 through Oakhurst, and accept the hour to the Valley.</li>
        <li>Eastern Sierra summer trip: Tioga Pass, after you have confirmed it is open.</li>
        <li>Hetch Hetchy: its own entrance, its own day, daylight only.</li>
      </ol>
