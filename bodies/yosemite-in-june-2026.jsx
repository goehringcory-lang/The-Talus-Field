...
window.ARTICLE_BODIES["yosemite-in-june-2026"] = function YosemiteInJune2026Body() {
  return (
    <>
      ...
      <p>
        In a normal year, warm June days melt the snowpack and send torrents of water over the Valley's granite walls. Yosemite Falls, Bridalveil Fall, Vernal and Nevada Falls all run at or near their peak. This is not a normal year. With so little snow to melt, the waterfalls peaked early. By late May, flows that would normally build through June were already declining. Yosemite Falls typically peaks in late May and can run strong into mid-June in an average snowpack year. In 2026, expect it to weaken noticeably by mid-June and reduce to a trickle by early July. Bridalveil Fall, which has a smaller watershed, will thin out sooner.
      </p>
      ...
      <p>
        Tioga Road opened on May 15, 2026, the earliest opening since 2015. In a typical year, it opens in late May or early June, and sometimes not until July. The low snowpack that is shortchanging the waterfalls gave us something in return: early access to the high country.
      </p>
      ...
      <p>
        <a href="/articles/cathedral-lakes-day-hike">Cathedral Lakes</a> is the signature Tuolumne day hike and one of the best in the park. The trail to Lower Cathedral Lake is about 3.5 miles one way with roughly 1,000 feet of gain, ending at a granite-rimmed alpine lake beneath Cathedral Peak. In early June it may still have snow patches on the upper trail. Bring traction devices if you are hiking before mid-month.
      </p>

      <p>
        Tuolumne Meadows Lodge opens June 5. The Tuolumne Meadows Store and Grill opens on the same timeline. This is also prime wildflower season: the meadows should be blooming by mid-June, though the compressed snowmelt may push the peak earlier and shorter than usual.
      </p>

      <p>
        Entering through Tioga Pass from the east side is also in play now. If you come over the pass from the Eastern Sierra, you can spend a full day in the high country without ever touching the Valley.
      </p>

      <h2>Glacier Point Road</h2>

      <p>
        Glacier Point Road opened on May 9, another early opening. This gives you access to Glacier Point itself, Sentinel Dome and Taft Point, and the <a href="/articles/glacier-point-road-open-2026">full Glacier Point Road experience</a>.
      </p>

      <p>
        It also opens the option I recommend to almost every June visitor: hike <a href="/articles/four-mile-up-panorama-down">Four Mile Trail up and Panorama Trail down</a>. This is the single best day hike in Yosemite, and in June you get waterfalls at every turn. Vernal and Nevada Falls are both visible from the Panorama Trail, and Illilouette Fall, which most visitors never see, is at its best in early June. Start by 7 a.m. to beat the heat on the Four Mile ascent.
      </p>
      ...
      <p>
        I wrote about <a href="/articles/yosemite-needs-a-reservation-system">why the park needs a reservation system</a>. For planning your June trip, here is what you need to know:
      </p>
      ...
      <p>
        <strong>Go outside the Valley.</strong> The Valley floor absorbs roughly 90 percent of Yosemite's visitors. <a href="/articles/hetch-hetchy-the-other-yosemite-valley">Hetch Hetchy</a> is fifteen minutes from the Big Oak Flat entrance and rarely crowded. Wawona and the <a href="/articles/giant-sequoias-fire-adaptation">Mariposa Grove</a> are on the south end. The Merced Grove has almost no one in it. And with Tioga open, the <a href="/articles/cathedral-lakes-day-hike">entire high country</a> is available. Plan at least one full day outside the Valley.
      </p>

      <p>
        <strong>If you arrive in the afternoon</strong>, the day is not wasted. The golden hour in Yosemite Valley in June starts around 6:30 p.m. and lasts until sunset around 8:25. Some of the best light and thinnest crowds of the day happen between 6 and 8 p.m.
      </p>
      ...
      <p>
        June in Yosemite Valley means daytime highs typically between 80 and 90 degrees Fahrenheit. The high country runs 15 to 20 degrees cooler. Mornings in the Valley start around 50 to 55 degrees and warm fast.
      </p>

      <p>
        <a href="/kit">Your day pack</a> for a June hike needs at minimum two liters of water per person for any hike over four miles, sun protection (the granite reflects everything), and a layer for elevation. If you are spending a full day in the high country, bring a real jacket. Afternoon thunderstorms are possible in Tuolumne by late June, and they move in fast at 8,600 feet.
      </p>

      <p>
        The Merced River will be swimmable in some sections by mid to late June. In a low snowpack year, it warms up earlier. Check current conditions before wading in. Early June flows can still be fast enough to be dangerous even in a drought year.
      </p>
