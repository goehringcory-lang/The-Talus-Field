...
window.ARTICLE_BODIES["yosemite-in-winter"] = function YosemiteInWinterBody() {
  return (
    <>
      ...
      <p>
        I am biased, because it is the road past my house, but the bias is earned: <strong>Highway 140</strong> through the Merced River canyon is the lowest and most reliable winter approach to the park. It follows the river up from Mariposa at canyon-bottom elevations, which means it takes rain when the higher entrances are taking snow. Storms still close it occasionally, and chain control still reaches it, but on an average winter day it is the entrance with the least weather on it. The other approaches, Highway 41 from Oakhurst and Highway 120 from Groveland, both climb well over 5,000 feet before dropping to the Valley and carry chain control more often. The full entrance-by-entrance comparison is in <a href="/articles/getting-to-yosemite">the entrances guide</a>; the winter summary is: take 140 if you can.
      </p>

      <p>
        <strong>Chain control</strong> is the part of winter driving that surprises first-time visitors, so here it is plainly. When conditions warrant, Caltrans and the park post chain requirements at checkpoints, in three levels. <strong>R1</strong> means chains are required unless you have snow tires. <strong>R2</strong> means chains are required unless you have four-wheel or all-wheel drive with snow tires. <strong>R3</strong> means chains on everything, no exceptions, and in practice roads usually just close before R3 is posted.
      </p>
      ...
      <p>
        The signature winter day trip in Yosemite is <strong>Dewey Point</strong>. From Badger Pass you follow the groomed road, then a marked snow route through the forest to the Valley rim, and the trees open onto a straight-down view of the Valley with El Capitan across the void, all of it snowbound and nearly silent. It runs about seven miles round trip depending on the route variant, an honest half-day on snowshoes for a reasonably fit party. There is no summer version of this experience. In July, Dewey Point is a nice viewpoint. In February it feels like being let in on something.
      </p>

      <p>
        For a gentler entry, the park offers <strong>ranger-led snowshoe walks</strong> from Badger Pass through the winter season, typically two hours through the woods near the ski area, with snowshoes provided for a small fee. They are unglamorous and quietly excellent, the ranger stopping to point out marten tracks and explain how a fir survives under ten feet of snow. Check the current Yosemite Guide or the <a href="/conditions">conditions page</a> for schedules before you drive up.
      </p>

      <h2>The rink under Half Dome</h2>

      <p>
        The <strong>Curry Village ice rink</strong> is the most improbable amenity in the park: an outdoor rink on the Valley floor where you skate loops while Half Dome stands overhead in winter light, with a fire pit at the edge for the between-sessions thaw. Skating has been happening at Curry Village for roughly a century, and it remains cheap, low-key, and better at dusk than at any other hour, when the granite goes pink and the rink lights come on. It is the rare Yosemite activity that works with small children, bad knees, and no planning.
      </p>

      <h2>The photography season</h2>

      <p>
        Here is the case for winter that needs no infrastructure at all: <strong>clearing storms are the best photographic conditions Yosemite offers</strong>, and winter is when they happen. A storm breaks up over the Valley, fog tears off the walls, snow outlines every ledge on El Capitan, and for an hour or two the place looks the way it did in the photographs that made it famous. Residents watch the radar and drive up for the clearing, and you can do a modest version of the same thing: if the forecast shows a storm ending mid-morning, be at Tunnel View when it does. Where to stand and when is covered in <a href="/articles/yosemite-photography-spots">the photography guide</a>.
      </p>

      <p>
        And February brings the park's strangest scheduled event. For about two weeks in the middle of the month, when the angle of sunset is right and the fall is running and the sky cooperates, <strong>Horsetail Fall</strong> on the east shoulder of El Capitan lights up orange at the last minute of the day and appears, briefly, to be on fire. The firefall draws real crowds, and drew a February weekend reservation requirement for four straight years before the park dropped it for 2026, which makes it the exception to everything else in this article; the full logistics are in <a href="/articles/horsetail-fall-firefall">the Horsetail Fall guide</a>, and <a href="/firefall">the firefall page</a> carries whatever rules the park sets for the current season.
      </p>

      <h2>The honest part</h2>

      <p>
        Winter asks things of you. The days are short: the sun clears the Valley rim late and drops behind it early, and the deep sections of the floor hold shade, and therefore <strong>black ice</strong>, all day. The paths around Curry Village and the base of the falls glaze over and stay glazed. Traction cleats for your boots cost little and prevent the most common winter injury in the park, which is not an avalanche, it is a tourist slipping on a paved path. Valley <strong>inversions</strong> park cold air and fog on the floor for days at a time, so a gray, raw morning in the Valley is often a blue one at Badger Pass, a thousand-plus feet higher.
      </p>

      <p>
        In exchange: the crowds are gone, genuinely gone, in a way no summer strategy can simulate. Lodging that books out months ahead in July has winter availability at winter prices, and the trade-offs between staying in the park and staying down the canyon are laid out in <a href="/articles/where-to-stay-in-yosemite">the lodging guide</a>. You will stand at viewpoints alone. You will hear the Valley, which in summer you mostly cannot.
      </p>
