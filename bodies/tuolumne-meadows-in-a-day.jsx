...
window.ARTICLE_BODIES["tuolumne-meadows-in-a-day"] = function TuolumneMeadowsInADayBody() {
  return (
    <>
      <p className="dropcap">
      ...
      <p>
        <strong>There is no gas at Tuolumne Meadows.</strong> Start here, because it is the one that strands people. The old station has been out of operation for years and travel sites still list it. Inside the park on the west side, Crane Flat is the only fuel, pay-at-pump around the clock, and the point where Tioga Road begins. On the east side your next fuel is Lee Vining, about forty-five minutes past the meadows. Fill up at Crane Flat on the way in whether or not you think you need to.
      </p>

      <p>
        <strong>The store, grill, and post office</strong> run a short summer season out of a temporary structure, and have for several years. <strong>Tuolumne Meadows Lodge</strong> runs roughly early June to mid-September in tent cabins. <strong>The campground</strong> came back in 2025 from a three-year, twenty-six-million-dollar rehabilitation as a 336-site campground, reservable through recreation.gov. <strong>White Wolf Lodge</strong>, down the road toward Crane Flat, has been closed by sewer line damage, with its campground running at reduced capacity and no potable water. The visitor center and wilderness center operate in season.
      </p>
      ...
      <Placeholder
        caption="The Tuolumne River winding through Tuolumne Meadows under summer cumulus, with the high country domes on the skyline"
      ...
      <p>
        <strong>Olmsted Point nature trail. Half a mile, a hundred feet of climb, half an hour.</strong> A short walk off the pullout onto open granite, looking down Tenaya Canyon at the back of Half Dome and up at Clouds Rest. This is the single highest ratio of view to effort on Tioga Road, and it is doable in sandals on a driving day.
      </p>
      ...
      <p>
        <strong>Tenaya Lake loop. Two and a half miles, flat.</strong> A big subalpine lake at 8,150 feet with a real sandy beach at the east end, ringed by a level trail. This is the family stop: the beach works for people who want to do nothing at all, and the loop works for people who want to move.
      </p>

      <p>
        <strong>Lukens Lake. A mile and six tenths, two hundred feet.</strong> Off Tioga Road well west of the meadows, through forest to a shallow lake in a wildflower meadow. Good for small children and fine in mosquito season if you come prepared for them.
      </p>

      <p>
        <strong>May Lake. Two and four tenths of a mile, five hundred feet.</strong> Steeper than the others but short, ending at a lake directly under Mount Hoffmann in the geographic center of the park.
      </p>

      <h2>If you want one real hike</h2>

      <p>
        <strong>Lembert Dome</strong> is the classic: two and eight tenths of a mile with 850 feet of climb, up the back of the dome that stands over the east end of the meadow, finishing on bare granite with the whole basin underneath you. Allow two and a half hours. It is a walk-up rather than a scramble, but the last stretch is open rock with real exposure at the edges, so it is a poor choice with a child who runs.
      </p>
      ...
      <p>
        Tuolumne Meadows is more than 4,500 feet above the Valley floor. If you slept in the Valley, or flew into California two days ago, you are arriving at an elevation your body has no preparation for. It does not usually present as dramatic mountain sickness. It presents as a headache after lunch, a shorter temper than usual, a child who is suddenly done, and a walk that felt much harder than a mile ought to feel.
      </p>
      ...
      <p>
        In July and August the Sierra high country builds thunderstorms out of a clear morning with startling speed. The pattern is reliable enough to plan around: clear at dawn, cumulus stacking by late morning, and the possibility of lightning from early afternoon on.
      </p>

      <p>
        The practical rule is to do the exposed thing first. Domes, summits, and open granite in the morning; meadow, forest, lakeshore, and lunch in the afternoon. Being the highest object on a bare granite dome with a storm building is the specific way this landscape hurts people, and it is entirely avoidable by reordering your day. Carry a rain shell in a daypack even when the morning makes it look ridiculous. <a href="/articles/yosemite-heat-safety-guide">The heat and weather guide</a> goes further into lightning.
      </p>

      <h2>Water, and the swimming question</h2>

      <p>
        Tenaya Lake and the Tuolumne River are both swimmable, in the sense that people swim in them and are pleased with themselves afterward. At 8,000 feet and above, water that has recently been snow is cold in a way that a Valley swimmer is not braced for, so the same rules apply as everywhere else in this park: get in where there is a beach, do not swim alone, and take the first thirty seconds seriously. <a href="/articles/swimming-in-the-merced">The swimming guide</a> covers the physiology, which matters more in cold water than anyone expects.
      </p>

      <p>
        Bring all your drinking water. There is very little to buy up there and the seasonal facilities cannot be assumed. Two liters a person is a floor, not a target, at that elevation and that sun.
      </p>

      <h2>A day, laid out</h2>
      ...
      <ol>
        ...
        <li><strong>Soda Springs and Parsons Lodge, early afternoon.</strong> Flat, shaded in stretches, and under trees if a storm arrives.</li>
        <li><strong>Tenaya Lake beach until you are ready to leave.</strong> This is the part everyone remembers and the part every itinerary cuts.</li>
        <li><strong>Drive out over Tioga Pass to Mono Lake if you are staying east</strong>, or back down to the Valley with two hours in hand before dark.</li>
      </ol>

      <h2>The short version</h2>

      <ol>
        <li>Budget three to four hours of driving around the day. Leave the Valley by seven.</li>
        <li>There is no gas at Tuolumne Meadows. Fill up at Crane Flat.</li>
      ...
      <ul>
        <li><a href="https://www.nps.gov/yose/planyourvisit/tioga.htm" target="_blank" rel="noopener noreferrer">Tioga Road, NPS Yosemite</a></li>
        ...
        <li><a href="https://www.nps.gov/yose/planyourvisit/tm.htm" target="_blank" rel="noopener noreferrer">Tuolumne Meadows, NPS Yosemite</a></li>
        <li><a href="https://www.nps.gov/yose/planyourvisit/hours.htm" target="_blank" rel="noopener noreferrer">Operating Hours and Seasons, NPS Yosemite</a></li>
