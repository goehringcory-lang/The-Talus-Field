...
window.ARTICLE_BODIES["memorial-day-skip-the-valley-go-high-2026"] = function MemorialDaySkipTheValleyGoHigh2026Body() {
  return (
    <>
      ...
      <p>
        We already got the preview. On Saturday, May 2, 2026, a normal early-May Saturday before the season had really started, the park's own alert reported every parking space in Yosemite Valley full by <strong>10:59 a.m.</strong> Memorial Day weekend is far busier than that. Saturday morning is the worst of it. The Park Service knows this; its advice for the weekend has been to spend the busiest hours anywhere but the Valley floor: Tuolumne Meadows, Wawona, Hetch Hetchy.
      </p>
      ...
      <p>
        It was a thin snow year (the park's April 1 snow survey at Tuolumne Meadows came in at 37 percent of average after a hot, dry March), the roads got plowed early, and both of the great high routes are already open ahead of their usual dates:
      </p>

      <ul>
        <li><strong>Glacier Point Road opened May 9, 2026</strong>, a day earlier than it did in 2025.</li>
        <li><strong>Tioga Road opened May 15, 2026</strong>, the earliest opening since 2015. (Tioga typically doesn't open until late May or even June.)</li>
      </ul>
      ...
      <p>
        If Glacier Point is the easy headliner, Tioga Road is the adventure. Highway 120 climbs east through the park to Tioga Pass at 9,945 feet, the crossing that <a href="/articles/yosemite-from-las-vegas">decides whether Las Vegas has a road into the park at all</a>, and right now it's a ribbon of pavement through a high country still pulling itself out of winter. You'll see country that's a solid two months behind the green Valley you drove away from. A few stops to build a day around:
      </p>
      ...
      <p>
        Save the big alpine hikes for your next trip. <strong>Cathedral Lakes</strong> and the other classic Tuolumne destinations are usually still snowbound this early and don't come into condition until late June or July. <a href="/articles/cathedral-lakes-day-hike">Bookmark the Cathedral Lakes day hike for later</a>.
      </p>

      <p>
        The catch up here is self-sufficiency. The road is open, but Tuolumne Meadows itself is barely awake: the store, grill, and campground are weeks from opening (this year the grill's season began June 13 and the campground's July 1), there's <strong>no gas anywhere past Crane Flat</strong>, and no reliable drinking water along Tioga Road this early. Fill the tank, pack all your own food and water, and store it in a bear locker. Bring layers, including <a className="aff-link" href={window.buildPatagoniaAffiliateLink("https://www.patagonia.com/search/?q=nano+puff")} target="_blank" rel="sponsored noopener noreferrer" data-aff-network="patagonia" data-aff-list="article_inline" data-aff-item-slug="memorial-day-skip-the-valley-go-high-2026" data-aff-name="Packable insulated jacket">a packable insulated jacket</a>. Sunny afternoons hit the low 60s, but nights drop to near freezing at this elevation, and an afternoon thunderstorm is possible.
      </p>
