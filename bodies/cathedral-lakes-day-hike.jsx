...
window.ARTICLE_BODIES["cathedral-lakes-day-hike"] = function CathedralLakesDayHikeBody() {
  return (
    <>
      <p className="dropcap">
      ...
      <ul>
        <li><strong>Total distance:</strong> roughly 9 to 10.5 miles round trip, depending on whether you visit Lower Cathedral Lake only, Upper Cathedral Lake only, or both.</li>
        <li><strong>Elevation gain:</strong> about 1,000 to 1,400 feet of cumulative gain.</li>
        <li><strong>Trailhead elevation:</strong> about 8,500 feet.</li>
        <li><strong>Lower Cathedral Lake elevation:</strong> 9,288 feet.</li>
        <li><strong>Upper Cathedral Lake elevation:</strong> 9,585 feet.</li>
      </ul>

      <p>
        The trail begins flat through the meadow approach, then climbs steadily through lodgepole pine forest for about three miles, gaining most of its elevation in this stretch. It crests on a forested bench where a signed junction points right to the lakes and continues straight along the John Muir Trail toward Sunrise. The Lower Cathedral Lake spur descends about a half-mile through forest to the lake's outlet stream. Upper Cathedral Lake sits in a granite bowl a few hundred yards past the junction, directly below Cathedral Peak.
      </p>
      ...
      <p>
        The best hiking conditions are typically <strong>mid-July through mid-September</strong>. Wildflowers in the meadows and forest understory peak in late July. The lake water reaches its warmest temperature (still cold) in early August. Fall light starts to change the character of the basin in mid-September.
      </p>
      ...
      <p>
        The trail itself is more interesting than most guidebooks make it sound. Here's what to notice, in the order you'll encounter it.
      </p>
      ...
      <p>
        <strong>The trail junction.</strong> At about three miles, the spur trail to Lower Cathedral Lake branches right while the John Muir Trail continues toward Sunrise. The junction is signed. Take Lower Cathedral first if you're doing both lakes. The descent and re-ascent is real, and you don't want it on tired legs at the end of the day.
      </p>

      <p>
        <strong>Lower Cathedral Lake.</strong> The outlet stream is on your right as you descend. The lake opens up suddenly, and the south shore, approached via a granite ramp, is the vantage point you've seen in photographs: Cathedral Peak rising directly across the water. The lake is deep enough to swim, cold enough to shock, and large enough that even with twenty other people scattered around the shoreline you can find a quiet shelf.
      </p>

      <p>
        <strong>The granite slabs above the lake.</strong> Scramble up the slabs west of the outlet and you get a higher perspective with almost guaranteed solitude. This is where the marmots tend to sun themselves. The view extends across the basin and down toward Tenaya Canyon.
      </p>
      ...
      <p>
        The peak is climbable. The standard route is a fifth-class climb of about 700 vertical feet from the base, often done as a long day from Tuolumne. Muir made the first recorded ascent in 1869 in work boots, alone. The Park Service does not encourage casual visitors to attempt it. If you have climbing experience and want to try, get current beta from the Yosemite climber community before going.
      </p>

      <h2>The Muir connection</h2>

      <p>
        John Muir camped here in late summer 1869 during his first season as a sheep tender in the high country. His journal entries from those weeks became the basis of <em>My First Summer in the Sierra</em>, published forty-two years later. The book includes the description of Cathedral Peak as "one of Nature's cathedrals, hewn from the living rock," and his solitary first ascent. He climbed it in work boots, carrying nothing.
      </p>

      <p>
        Muir returned to this basin repeatedly over the next few decades. He wrote about it in multiple books. The Cathedral region became a touchstone in his evolving argument for wildland protection, an argument that eventually reached a president and reshaped the boundaries of what became Yosemite National Park.
      </p>
      ...
      <p>
        The <a href="/kit">day pack basics</a> are covered elsewhere. The Cathedral-specific version: carry three liters of water minimum, because there's no reliable potable water between the trailhead and the basin. Bring layers. Late July at 9,500 feet can be 75 degrees and clear or 50 degrees with a thunderstorm building in the same afternoon, and the wind off the lake at midday can be sharp. A rain shell is not optional in July and August; afternoon thunderstorms are common and develop fast, so plan to be off exposed granite by early afternoon if storms are in the forecast. Sun protection matters at this altitude. UV at 9,500 feet is intense and the lake basins are exposed.
      </p>
      ...
      <p>
        The main John Muir Trail continues from the Cathedral Lakes junction up over Cathedral Pass and on toward Sunrise. It is tempting to keep going. Don't, unless you've planned for it. Most day hikers should stop at the lakes and be content with that. (If you do want to keep going, see the through-hike section below.)
      </p>

      <p>
        If you're camping, know the rules: campfires are prohibited at Lower Cathedral Lake, all camping must be at least 100 feet from water and trails, and you need to be at least four trail miles from Tuolumne Meadows. A wilderness permit is required for any overnight stay. If you're planning an overnight, see <a href="/kit">packing for a Yosemite backpack</a>.
      </p>

      <p>
        Don't swim before July. The water is too cold and snow patches around the lake make the shore slippery and unstable. The lake does not fully ice out in many years until late June. And don't rely on the trail being clear of snow before mid-July. I've seen the upper switchbacks buried into early July in heavy-snow years. Bring traction devices if you're hiking before mid-July, and be willing to turn around at the snowline.
      </p>
      ...
      <ul>
        <li><a href="https://www.nps.gov/places/000/cathedral-lakes-trailhead.htm" target="_blank" rel="noopener noreferrer">Cathedral Lakes Trailhead, NPS Yosemite</a></li>
        <li><a href="https://www.nps.gov/yose/planyourvisit/tm.htm" target="_blank" rel="noopener noreferrer">Tuolumne Meadows and Tioga Road, NPS</a></li>
        <li><a href="https://www.usgs.gov/geology-and-ecology-of-national-parks/geology-yosemite-national-park" target="_blank" rel="noopener noreferrer">Geology of the Yosemite Area, USGS</a></li>
        <li><a href="https://vault.sierraclub.org/john_muir_exhibit/writings/my_first_summer_in_the_sierra/" target="_blank" rel="noopener noreferrer">My First Summer in the Sierra, by John Muir (1911)</a></li>
      </ul>
    </>
  );
};
