...
window.ARTICLE_BODIES["yosemite-in-one-or-two-days"] = function YosemiteInOneOrTwoDaysBody() {
  return (
    <>
      ...
      <p>For years the constraint on a Yosemite day was a permit. You planned your trip around whether you could secure a reservation, and the planning often soured the trip before it started. In 2026 that constraint is gone. What replaces it is older and more honest: logistics, timing, and parking. A deliberate <a href="/itineraries">one-day Yosemite itinerary</a> is not a compromise, and a two-day one is the same trip with room to breathe. It is the version of Yosemite that respects your time and rewards an early alarm. The rest of this guide is about what to do in Yosemite in a day: doing less, earlier, on purpose. If the scale of the place is what worries you, start with <a href="/articles/first-time-yosemite-overwhelm">first-time Yosemite overwhelm</a> and come back.</p>
      ...
      <h2 id="sec-0-the-2026-reservation-and-crowd-context">The 2026 reservation and crowd context</h2>
      <p>There is no day-use reservation in Yosemite in 2026. There is no peak-hours reservation either. The timed-entry system that ran in various forms from 2020 through 2024, and the narrower peak-hours system that ran in 2025, are both gone. The Park Service announced the change on February 18, 2026, citing 2025 traffic data that suggested the systems were no longer doing enough to justify the friction they created. For the first time in years a Yosemite day trip needs no advance permit: decide on a Thursday night, drive in Friday morning, and simply do it.</p>
      <p>The catch is that demand did not disappear when the reservation did. It moved. It moved to the parking lots, which fill on their own schedule, and to the entrance-gate lines, which back up when everyone arrives at once. The reservation used to ration the road. Now nothing does, which means you ration yourself. The practical takeaway is the one rangers have given for decades and that the data still supports: arrive before 8 a.m., and choose a weekday over a weekend if you have any choice at all. As of the September bulletin, the park's own advice confirms the pattern held all summer: Valley lots full by late morning, with the standing advice to arrive before 8 a.m. or after 4 p.m. <a href="/articles/yosemite-valley-parking-guide">The Valley parking guide</a> has the three lots and what to do once they are gone. Text <em>ynptraffic</em> to 333111 for the park's live traffic alerts, and check the <a href="/now">Park Bulletin</a> for what is open and running the exact week you visit. We cover the no-reservation logistics in more depth in <a href="/articles/yosemite-without-reservations-2026">Yosemite without reservations in 2026</a>.</p>
      <p>One more 2026 change, and this one is firm: international visitors now pay a $100 surcharge per person age 16 and older, on top of the standard entrance fee, in effect since January 1. A car of four foreign visitors pays the $35 vehicle fee plus $400, so for a group the $250 nonresident annual pass can pay for itself. It does not affect domestic visitors.</p>

      <h2 id="sec-1-before-you-leave-the-gateway-town">Before you leave the gateway town</h2>
      <p>The single most useful thing you can do for a Yosemite day happens before you reach the gate. Fuel up outside the park. There is no gas in Yosemite Valley or Yosemite Village. In-park fuel exists only at Crane Flat on Highway 120 and at Wawona on Highway 41 (both pump 24 hours with a card), and both are priced like the captive options they are. The nearest reasonable fill is in the gateway towns: El Portal on Highway 140, Oakhurst on Highway 41 (generally the cheapest of the bunch), and Lee Vining on the east side (generally the most expensive). For a fuller comparison of where to base yourself, see <a href="/articles/yosemite-gateway-towns-compared">Yosemite gateway towns compared</a>.</p>
      ...
      <p>If parking is the part you dread, skip it. YARTS, the regional transit system, runs into the Valley on Highway 140 from Merced, Mariposa, and El Portal; on Highway 41 from Fresno; on Highway 120 from Sonora; and on Highway 395 from Mammoth and Lee Vining. Whether the fare covers your park entrance fee is currently unsettled, with the Park Service and the YARTS fares page saying opposite things, so budget for the gate; <a href="/articles/yosemite-shuttle-and-yarts">the shuttle and YARTS guide</a> works through the fares and the cases where driving still wins.</p>

      <h2 id="sec-2-one-day-in-yosemite-valley-the-four-stop">One day in Yosemite Valley: the four-stop sequence</h2>
      ...
      <ol>
        ...
        <li><strong>Lower Yosemite Fall loop.</strong> Roughly a mile, paved and flat. The 320-foot lower drop is the one you stand under; the 1,430-foot upper drop is the one you crane your neck at. With the middle cascades between them, the whole thing falls 2,425 feet, the tallest waterfall in North America, and the loop gives you the lower and upper without a climb. One seasonal honesty note: the falls typically go thin by midsummer and dry by late summer, so from July on you are walking the loop for the amphitheater and the scale, not the water.</li>
      ...
      <h2 id="sec-3-what-to-skip-on-a-one-day-visit">What to skip on a one-day visit</h2>
      ...
      <h2 id="sec-4-a-realistic-hike-if-you-want-one">A realistic hike, if you want one</h2>
      ...
      <p>A 2026 caveat that outranks the seasonal one: trail work closes sections of the Mist Trail on weekdays, Monday through Thursday from 7 a.m. to 3:30 p.m., into late October, with the John Muir Trail as the detour. If your one day is a Monday through Thursday, do the footbridge early, plan the climb for after 3:30 p.m., or save the corridor for a Friday-through-Sunday visit; the <a href="/articles/mist-trail-the-real-guide">Mist Trail guide</a> tracks the specifics. And a seasonal caveat that catches people every year: the steep Mist Trail steps close in winter and icy conditions, and hikers reroute via the longer, gentler John Muir Trail. Spray and slick rock peak in spring snowmelt, which is exactly when the trail is most beautiful and most treacherous. All of these leave from Happy Isles or the nearby shuttle stops. Start early, carry water, wear real shoes, and set a turnaround time before you leave the car. Then pick one and do it well. One trail done properly beats two trails done in a hurry.</p>

      <h2 id="sec-12-one-day-in-yosemite-with-kids">One day in Yosemite with kids</h2>
      <p>The four-stop sequence above is the kids' itinerary too, with two edits. Every stop on it is paved or boardwalk and under a mile: Bridalveil is a half mile, the Lower Yosemite Fall loop is a flat mile with a stroller-friendly paved path, and Cook's Meadow is a boardwalk that lets a five-year-old walk toward Half Dome without a hill. The first edit is the hike: swap the Mist Trail for the Vernal Fall footbridge (1.6 miles round trip, a real destination, and no granite staircase in the spray) or for Mirror Lake in spring. The second is the shape of the afternoon: park once, ride the free Valley shuttle instead of moving the car, and plan the midday around the river rather than a viewpoint, because a sandbar on the Merced in July is the best thing in the park for anyone under ten. Bring the bear rules into the car with you; children are the ones who leave the granola bar on the seat. <a href="/articles/yosemite-with-kids-no-reservations-2026">Yosemite with kids</a> covers bathrooms, shuttle stops, and the walks by age.</p>

      <h2 id="sec-13-one-day-in-yosemite-from-san-francisco">One day in Yosemite from San Francisco</h2>
      <p>It can be done, and the arithmetic decides whether it is worth doing. The Bay Area to the Arch Rock or Big Oak Flat entrance is about four hours in clear traffic, plus 30 to 45 minutes of park road to the Valley floor. A 4 a.m. departure lands you at Tunnel View by nine and gives you until mid-afternoon before you have to turn around; a 7 a.m. departure lands you in the lots at the exact hour they fill and hands you a day of circling. The better version of the same trip is to drive up the evening before, sleep in Mariposa or Groveland, and start the four-stop sequence at dawn, which turns a fourteen-hour day into a real one. <a href="/articles/yosemite-day-trip-from-bay-area">The Bay Area day trip</a> does the daylight math by month and names the point at which the drive stops being worth it, and <a href="/articles/getting-to-yosemite">the entrances guide</a> has the routes.</p>

      <h2 id="sec-5-two-days-in-yosemite-if-you-have-a-secon">Two days in Yosemite: if you have a second day</h2>
      ...
      <h3>Glacier Point</h3>
      <p>Glacier Point Road reopened May 9, 2026, after a multi-season rehabilitation, and it is the single best second day for most visitors. It is open as this is written in late September, and it closes for the winter with the first heavy snow, typically in November, so a late-season second day should confirm it on the <a href="/now">Park Bulletin</a> before counting on it. The overlook gives you Half Dome at eye level and the Valley 3,000 feet below in one frame, with no hike required to earn it. One note that matters: there is no drinking water at the overlook this season, so bring your own. On the way up, two short detours pay off well: Sentinel Dome (about 2.2 miles round trip) for a 360-degree summit, and Taft Point for a vertigo-inducing look straight down into the Valley. The full picture is in our <a href="/articles/glacier-point-road-open-2026">Glacier Point Road guide</a>.</p>
      ...
      <p>Tioga Road opened May 15, 2026, the earliest opening since 2015, which makes this an unusually good season to point the second day east. Tuolumne Meadows, Tenaya Lake, and Olmsted Point are the marquee stops, and the whole thing is comfortably a half-day if you keep moving. Basing east at Lee Vining works well if your trip runs over Tioga Pass anyway.</p>
      <p>Two days in September or October is the best version of this trip for a second-day menu: every road is still open, the crowds are down from July, and the light is low and gold. The trade is water, since the falls are near dry by September, and a few 2026 specifics: the Mist Trail is closed for repairs Monday through Thursday through October, the Tuolumne Meadows store, grill, and High Sierra Camps close in the first two weeks of September, and the Glacier Point overlook has no drinking water this season. <a href="/articles/yosemite-in-fall">Yosemite in fall</a> and <a href="/articles/yosemite-in-september-2026">Yosemite in September 2026</a> have the month-by-month detail.</p>
      ...
      <h2 id="sec-6-where-to-sleep">Where to sleep</h2>
      ...
      <h2 id="sec-7-when-to-go-to-yosemite-month-by-month">When to go to Yosemite: month by month</h2>
      ...
      <h2 id="sec-8-where-to-eat">Where to eat</h2>
      ...
      <p>If you do want a sit-down meal in the park, the options are short and known. Base Camp Eatery, the food court at Yosemite Valley Lodge, is the fast, reliable default for a hot plate, and it is usually the last kitchen in the Valley still taking orders in the evening. Degnan's in Yosemite Village handles a quick lunch without much ceremony. The Ahwahnee dining room is the splurge, a grand room with a dress code and prices to match, and worth doing once if the budget allows. For the full locked-down list of what is open and what it costs, see <a href="/articles/where-to-eat-yosemite">where to eat in Yosemite</a>.</p>

      <h2 id="sec-9-what-to-bring">What to bring</h2>
      ...
      <p><strong>Is one day in Yosemite enough?</strong> Yes, for the Valley, if you are in the park by 8 a.m. and stay on the floor. Tunnel View, Bridalveil Fall, the Lower Yosemite Fall loop, and Cook's Meadow fit in one day with time to spare for a hike or an hour by the river. It is not enough for Glacier Point, the Mariposa Grove, or Tuolumne, which each need a second day.</p>
      <p><strong>Can you do Yosemite in 2 days?</strong> Yes, and two days is the trip we would hand most first-time visitors: the Valley on day one, and Glacier Point, the Mariposa Grove, or Tioga Road on day two. Two days does not cover all three of those; pick the one that matches what you came for.</p>
      ...
      <p><strong>Is Glacier Point Road open?</strong> Yes, as of late September 2026. It opened for the season on May 9 and closes for the winter with the first heavy snow, typically in November. There is no water at the overlook, so fill your bottles before you drive up.</p>
      ...
      <p><strong>Is the Mist Trail open?</strong> Mostly. Trail work closes sections of it Monday through Thursday, 7 a.m. to 3:30 p.m., into late October 2026, with a detour via the John Muir Trail. Friday through Sunday it runs normally, and the Vernal Fall footbridge stays the reliable short option.</p>
      ...
      <p><strong>How many days in Yosemite without hiking?</strong> One day covers the Valley from the car and the paved paths, and a second day adds Glacier Point, which has one of the great views in North America a few steps from the parking lot. <a href="/articles/yosemite-for-non-hikers">The non-hiker's guide</a> has the full list.</p>
      ...
      <h2 id="sec-11-the-honest-pitch">The honest pitch</h2>
