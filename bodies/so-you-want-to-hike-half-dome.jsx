...
window.ARTICLE_BODIES["so-you-want-to-hike-half-dome"] = function SoYouWantToHikeHalfDomeBody() {
  return (
    <>
      <p className="dropcap">
        I get it. You want to hike Half Dome.
      </p>
      ...
      <p>
        Both lotteries charge a $10 non-refundable application fee. If you win, there's an additional $10 per person permit fee. Permits are non-transferable and require photo ID at the subdome checkpoint.
      </p>
      ...
      <p>
        If what you're after is the cables, the specific experience of pulling yourself up the back of Half Dome on steel cables, standing on that famous summit, looking down at the Valley from the place in every photograph, then yes, you need the permit, and you should go for it. Play both lotteries. I hope you get it.
      </p>
      ...
      <p>
        As soon as Tioga Road opens, typically late May to early June depending on the snow year, this hike is available. In a low snow year, the trail can be clear by early June. You might encounter a few snow patches here and there in the first couple of weeks after Tioga opens, but the trail is well-defined and the route is intuitive. Bring trekking poles if you're hiking in early season, and gaiters if the snow is still melting. By late June or early July, the trail is fully clear.
      </p>
      ...
      <p>
        <strong>Miles 5.5 to 6.5: The spine.</strong> And then the trees fall away entirely.
      </p>

      <p>
        The final half-mile to the summit follows a narrow granite ridge, the spine of Clouds Rest. The ridge is maybe 10 to 20 feet wide in most places, with the north side dropping thousands of feet into Tenaya Canyon and the south side falling steeply toward the Merced River drainage. The trail uses the slightly less exposed south side of the ridge for most of the approach, but there's no hiding from the fact that you're walking along the top of a wall.
      </p>

      <p>
        It's not technical. You don't need ropes or climbing experience. But if you're afraid of heights, this section will test you. The granite is solid underfoot (good traction when dry) and the trail is clear. But the exposure is real, and on a windy day, it's intense.
      </p>

      <p>
        Take your time. Stop often. Look around. The views open in every direction and they only get better the higher you go.
      </p>

      <p>
        <strong>The summit.</strong> The top of Clouds Rest is a broad granite platform. Not a point, not a knife-edge, a place where you can sit, eat lunch, lie on the warm rock, and take in a panorama that most people in Yosemite never see.
      </p>
      ...
      <p>
        It's one of the great summits in the national park system. And on a Tuesday in June, you might have it to yourself.
      </p>

      <h2>Water and logistics</h2>

      <p>
        <strong>Water plan:</strong> The only reliable water on the trail is in the first couple of miles: Tenaya Creek at the trailhead, and a few seasonal streams and the marshy meadow in the middle section. After that, there's nothing until you return. Carry at least 3 liters. If it's a hot day or you're a heavy drinker, carry 4. A water filter is useful in early season for topping off at the meadow streams, but by late July those may be dry. For a full day-pack checklist, see the <a href="/kit">day pack guide</a>.
      </p>
      ...
      <p>
        <strong>What to wear:</strong> Trail runners or hiking boots with good traction. The granite on the spine is grippy when dry but slick when wet, same as Half Dome's cables. Layers for the summit: at nearly 10,000 feet, it can be 15 to 20 degrees cooler than the Valley and windy even on a calm day below. Sun protection is critical at this elevation.
      </p>

      <p>
        <strong>The trailhead creek crossing:</strong> Tenaya Creek crosses the trail within the first few hundred feet. In spring and early summer when snowmelt is heavy, this can be a real ford: knee-deep, cold, fast. By mid-July, it's usually a rock-hop. By late August, it might be dry. If you're hiking in early season, bring shoes you don't mind getting wet or carry sandals for the crossing.
      </p>

      <h2>Safety</h2>

      <p>
        Clouds Rest is safer than Half Dome in most respects. No cables, no conga line, no permit-pressure pushing people to hike in conditions they shouldn't. But it has its own risks.
      </p>

      <p>
        <strong>Lightning.</strong> This is the big one. The summit and spine are fully exposed at nearly 10,000 feet. Afternoon thunderstorms are common in July and August. If you see dark clouds building or hear distant thunder, descend immediately. Do not wait to see if the storm passes. Get off the ridgeline and into the trees. The standard rule applies: summit before noon, descend by early afternoon.
      </p>

      <p>
        <strong>The spine exposure.</strong> The narrow ridge is not dangerous if you're careful, but it demands respect. Stay on the trail, don't scramble onto side ledges for photos, and be honest with yourself about your comfort with heights. There's an old alternate trail that goes around the east side of the summit, avoiding the exposed ridgeline, though it's less maintained and can be hard to follow.
      </p>
      ...
      <p>
        <strong>Early season hazards.</strong> Snow patches on the trail can linger into late June, especially on north-facing slopes. Post-holing through soft snow is exhausting and disorienting. If you're hiking in the first two weeks after Tioga opens, check current conditions and be prepared to turn around if snow coverage is too heavy.
      </p>

      <h2>Half Dome vs. Clouds Rest: the honest comparison</h2>
      ...
      <table>
        <thead>
          <tr>
            <th></th>
            <th>Half Dome</th>
            <th>Clouds Rest (from Sunrise)</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr><td><strong>Biggest risk</strong></td><td>Wet cables, lightning, overcrowding</td><td>Lightning, exposure on spine</td></tr>
        </tbody>
      </table>

      <p>
        Half Dome gives you the cables. Nothing else in the park, nothing else in any park, gives you that experience. The cables are singular.
      </p>
