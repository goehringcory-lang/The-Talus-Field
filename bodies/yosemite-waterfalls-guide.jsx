...
window.ARTICLE_BODIES["yosemite-waterfalls-guide"] = function YosemiteWaterfallsBody() {
  return (
    <>
      <p className="dropcap">
      ...
      <p>
        Two practical notes. First, the <strong>Lower Yosemite Fall loop</strong> is a one-mile paved trail, flat and wheelchair accessible, and it delivers one of the best waterfall views in the park for zero effort; I've written more about it in the <a href="/articles/yosemite-accessibility-guide">accessibility guide</a>. Second, in deep winter the base of the Upper Fall grows a <strong>frazil ice cone</strong>, a hill of frozen spray that can stand hundreds of feet tall by February. The fall in January is modest, but the cone is worth the walk.
      </p>

      <h2>Bridalveil: the one that never quits</h2>

      <p>
        <strong>Bridalveil Fall</strong>, 620 feet, is the first waterfall nearly every visitor sees, hanging on the south wall as you come out of the Wawona Tunnel or up Highway 140 into the Valley. It is also the most dependable: the only major Valley fall that flows <strong>year-round</strong>, heavy in spring, a drifting ribbon by October, but always present.
      </p>
      ...
      <p>
        The hike is the most popular hard trail in the park and has real rules worth knowing: wet granite steps, crowd chokepoints, and a smarter descent route via the John Muir Trail. I've covered all of it in <a href="/articles/mist-trail-the-real-guide">the real guide to the Mist Trail</a>. From the same corridor you can also catch <strong>Illilouette Fall</strong> (370 feet), which hides in a side canyon and shows itself in glimpses from the trail below Vernal; the full view requires the Panorama Trail from Glacier Point. Illilouette drains a big basin and holds water later than the rim falls, well into fall most years.
      </p>
