...
window.ARTICLE_BODIES["where-to-eat-yosemite"] = function WhereToEatYosemiteBody() {
  return (
    <>
      ...
      <p>
        <strong>Oakhurst</strong> is the southern gateway and the largest gateway community by population. It also has more chain restaurants than any other gateway combined. Skip those.
      </p>
      ...
      <p style={{ marginTop: 32, fontStyle: "italic", color: "var(--ink-3)" }}>
        For where to base yourself, see <a href="/articles/yosemite-gateway-towns-compared">Yosemite gateway towns compared</a> and <a href="/articles/where-to-stay-in-yosemite">the lodging guide</a>. For one-day and two-day itineraries, see <a href="/articles/yosemite-in-one-or-two-days">One day or two in Yosemite</a>. For what a trip actually costs, see <a href="/articles/yosemite-trip-cost-budget-2026">the budget breakdown</a>.
      </p>
    </>
  );
};
