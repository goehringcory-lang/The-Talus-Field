/* global React, Placeholder, MotifSun */

window.ARTICLE_BODIES = window.ARTICLE_BODIES || {};

window.ARTICLE_BODIES["swimming-in-the-merced"] = function SwimmingInTheMercedBody() {
  return (
    <>
      <p className="dropcap">
      ...
      <p>
        The Merced is a snowmelt river. It does not warm up gradually and evenly the way a lowland river does; it runs high, fast and near freezing through the spring melt, then drops over a few weeks into something entirely different. The same stretch of water that will drown a strong adult in May is a place where six-year-olds stand around in ankle-deep water in August.
      </p>

      <p>
        The practical version, and this is the one the site has taken as its position for years: <strong>do not swim in the Merced in spring.</strong> Through the melt the current is stronger than it looks, the water is cold enough to disable you in under a minute, and spring is when people get carried off the bank. By high summer, once the flow has dropped and the water has had weeks of sun on shallow granite, it becomes the family swimming river everybody pictures. By September it is low, warm and slow.
      </p>
      ...
      <p>
        There is a gauge on the Merced at Pohono Bridge, at the west end of Yosemite Valley, and it is the number the park itself regulates against. The park's own boating rule keys off it: when the Pohono Bridge gauge reads above four feet at eight in the morning, flotation is mandatory for everyone on the water. That threshold is a useful signal even if you have no intention of getting into a boat. If the river is high enough that the Park Service has made life jackets compulsory for rafters, it is not a swimming day, and no amount of the water looking calm at your particular beach changes that.
      </p>

      <p>
        Check current river conditions and any posted closures on the park's conditions page before you go, and look at the river itself when you arrive. Water moving fast enough to push a stick along faster than you would walk is water that will move you too.
      </p>
      ...
      <Placeholder
        caption="A low, clear stretch of the Merced River in Yosemite Valley in late summer, granite boulders standing above a shallow green pool"
      ...
      <p>
        <strong>Sentinel Beach</strong> is the default: a sandy bank on the south side with a picnic area attached, calm by late summer, and Half Dome visible from the water. It is the one to take small children to.
      </p>
      ...
      <p>
        <strong>Devil's Elbow</strong> is a bend on Northside Drive that turns into a good swimming reach once the river drops. <strong>The Swinging Bridge</strong> area, on Southside Drive with Upper Yosemite Fall in the view, is shallow and sandy and the best wading spot in the Valley for toddlers. Jumping or diving from the bridge itself is not permitted. Note also that there are two Swinging Bridges in this park: this one, and a different one down in Wawona.
      </p>
      ...
      <p>
        Swimming is <strong>prohibited</strong>, not discouraged, in a specific list of places. Above Vernal Fall, that means <strong>Emerald Pool and the Silver Apron</strong>. It also means Hetch Hetchy Reservoir and the first mile up its tributaries, the Dana Fork of the Tuolumne, Lake Eleanor where posted, and the Wawona domestic water intake and the hundred yards above it.
      </p>
      ...
      <p>
        In July 2011 three visitors in their twenties, Hormiz David, Ninos Yacoub and Ramina Badal, climbed over the metal guardrail about twenty-five feet above the brink of Vernal Fall, after other hikers had called out to them not to. All three went over. The recoveries took months. <a href="/articles/mist-trail-the-real-guide">The Mist Trail guide</a> makes the same point from the trail's side, and it is the single rule on that trail that has cost the most lives: the water above a waterfall is moving faster than it appears, the granite under it is polished and frictionless, and there is no version of losing your footing there that you recover from.
      </p>

      <blockquote>Never swim above a waterfall. Not at the top of Vernal Fall, not at the top of Nevada Fall, not in any pool that drains toward an edge you cannot see over.</blockquote>
      ...
      <p>
        <strong>Strainers.</strong> A submerged log or a fallen branch lets water through and does not let you through. This is the classic river killer and it is invisible from upstream. Never swim toward or under downed timber in moving water.
      </p>

      <p>
        <strong>Foot entrapment.</strong> Standing up in moving water deeper than your knees is how a foot gets wedged between rocks and the current puts you face down. If you are being carried, float on your back with your feet up and pointing downstream, and do not try to stand until you are out of the current.
      </p>

      <p>
        <strong>Slick rock.</strong> Granite at the waterline grows a film of algae that is far more slippery than it looks, and most Merced injuries are not drownings at all. They are people going down hard on rock. Water shoes are not overkill here; the riverbed is cobble and the banks are polished stone.
      </p>

      <p>
        <strong>Water that looks slower than it is.</strong> A smooth surface means depth, not calm. The fastest water in a river is usually the water making the least noise.
      </p>
      ...
      <ol>
        <li>Do not swim during the spring melt. High summer into September is the season, and the changeover moves with the snowpack rather than the calendar.</li>
        <li>If the Pohono Bridge gauge is above four feet, the park requires life jackets on the water. Treat that as the river telling you it is not a swimming day.</li>
        <li>Cold water disables you in the first minute, before hypothermia is anywhere in the picture. Get in slowly, never alone.</li>
        <li>Swim at the sandy beaches: Sentinel, Cathedral, Devil's Elbow, Swinging Bridge. There are no lifeguards on the river.</li>
        <li>Swimming is prohibited above Vernal Fall, at Emerald Pool and the Silver Apron, and in the several other places the park lists. That is a rule, not advice.</li>
        <li>Never swim above any waterfall, anywhere, at any flow.</li>
        <li>Enter and exit only at sandy beaches, for the bank's sake and for yours.</li>
        <li>Wawona is warmer, Tenaya Lake is colder, and both are worth the drive.</li>
      </ol>
      ...
      <ul>
        ...
        <li><a href="https://www.nps.gov/yose/planyourvisit/boating.htm" target="_blank" rel="noopener noreferrer">Boating and Rafting, NPS Yosemite</a></li>
        ...
        <li><a href="https://www.nps.gov/yose/learn/news/vfallsar11b.htm" target="_blank" rel="noopener noreferrer">Vernal Fall search and rescue, July 2011, NPS Yosemite</a></li>
        <li><a href="https://www.nps.gov/yose/blogs/turning-blue-in-the-emerald-pool.htm" target="_blank" rel="noopener noreferrer">Turning Blue in the Emerald Pool, NPS Yosemite</a></li>
        <li><a href="https://www.nps.gov/yose/getinvolved/mrp.htm" target="_blank" rel="noopener noreferrer">Merced Wild and Scenic River Plan, NPS Yosemite</a></li>
      </ul>
    </>
  );
};
