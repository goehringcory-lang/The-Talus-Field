...
window.ARTICLE_BODIES["where-to-stay-in-yosemite"] = function WhereToStayInYosemiteBody() {
  return (
    <>
      ...
      <h2>The Ahwahnee: the splurge, and when it earns it</h2>
      ...
      <h2>Yosemite Valley Lodge: the location is the product</h2>
      ...
      <h2>Curry Village: canvas, bear boxes, and proximity</h2>
      ...
      <h2>Housekeeping Camp: the sleeper pick</h2>
