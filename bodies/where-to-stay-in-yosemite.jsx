...
window.ARTICLE_BODIES["where-to-stay-in-yosemite"] = function WhereToStayInYosemiteBody() {
  return (
    <>
      ...
      <p>
        <strong>Yosemite Valley Lodge</strong> is the park's standard hotel: low-slung motel-style buildings, clean and functional rooms, a food court, a pool in summer. Nobody has ever described the architecture as memorable. What it has instead is a position directly across the road from <strong>Lower Yosemite Fall</strong>, in the busiest and most convenient part of the Valley, on the shuttle loop, walking distance to the falls trail and an easy ride to everything else. In spring you can hear the waterfall from the grounds at night.
      </p>
      ...
      <p>
        In summer only, when Tioga Road is open, the park has historically run two clusters of tent cabins in the high country: <strong>White Wolf Lodge</strong>, at 8,000 feet off Tioga Road, and <strong>Tuolumne Meadows Lodge</strong>, at 8,700 feet near the meadows and the river. Both are canvas tent cabins with wood stoves, shared facilities, and dining rooms that serve family-style meals, and both are small, short-season and hard to book. <strong>White Wolf Lodge is closed</strong>, shut by the Park Service over severely damaged sewer lines, with no reopening announced; the campground beside it stayed open through 2026 without potable water. Tuolumne Meadows Lodge ran its normal season. Both operate on the park's schedule rather than yours, so check that the one you want is actually open for your year before you plan around it.
      </p>
      ...
      <p>
        Everything above books through travelyosemite.com, and reservations open <strong>366 days in advance</strong>, one year and a day ahead, on a rolling basis. For peak summer dates at the Valley properties, availability at the moment of release is measured in minutes. If your dates are fixed and in July, you set a reminder for the morning your window opens, and you book at that moment or you likely do not book at all.
      </p>
