...
window.ARTICLE_BODIES["yosemite-with-kids-no-reservations-2026"] = function YosemiteWithKidsBody() {
  return (
    <>
      <blockquote>
        <strong>If you're reading this in the car:</strong> Arrive before 9 AM. Park at Yosemite Village. Get the Junior Ranger booklet at the visitor center. Hike Lower Yosemite Fall. Don't swim before mid-July. Bear boxes are not optional. You're going to have a great day.
      </blockquote>

      <p className="dropcap">
        You're going to Yosemite with your kids. Maybe you decided last week. Maybe you decided this morning. You Googled "Yosemite with kids" and got seventeen articles that assume you booked a campsite in February and planned your itinerary on a spreadsheet. You didn't. Your trunk has a cooler with last night's leftovers, somebody's soccer cleats, and a bag of goldfish crackers that may or may not be open.
      </p>
      ...
      <p>
        This is the guide for the family that didn't plan six months ahead. Everything here works for a one-day trip, and I'll tell you what to do if you're lucky enough to have a second.
      </p>

      <h2>The night before</h2>

      <p>
        If you're staying outside the park, and if you're reading this article, you probably are, because campgrounds and lodges inside Yosemite book up months in advance, here's what to do tonight.
      </p>

      <p>
        <strong>Book a room in Mariposa.</strong> It's the best gateway town for families. About 45 minutes from the Valley, with more lodging options than any other gateway, a real grocery store, gas stations, and restaurants that aren't terrible. Our <a href="/articles/yosemite-gateway-towns-compared">gateway towns guide</a> has the full comparison, but if you're booking tonight: Mariposa. Call around. Last-minute rooms exist, especially midweek.
      </p>

      <p>
        If you're camping, the campgrounds inside the park are almost certainly full. But there are first-come-first-served options in the Sierra National Forest just outside the park boundary, and the Mariposa Fairgrounds campground runs about $35 a night with no reservation needed. It's not glamorous, but it's a place to sleep, and your kids won't care.
      </p>
      ...
      <p>
        From Mariposa, it's about 45 minutes to the Valley via Highway 140 through El Portal. Leave by 7:15 and you'll be parked by 8. From Oakhurst, add 15 minutes. From Groveland, it's more like 75 minutes. Leave by 6:45.
      </p>

      <p>
        <strong>Where to park.</strong> Head straight for the day-use parking at Yosemite Village. It's centrally located, close to the visitor center (which you need), and the shuttle stops here. If the Village lot is full, the lot near Yosemite Valley Lodge usually has turnover by mid-morning as early risers leave. Don't waste time circling Curry Village. It's far from everything you want to do first.
      </p>
      ...
      <p>
        The booklet has activities keyed to different spots in the park, things to find, questions to answer, sketches to make. It gives your entire day a structure without you having to create one. Your kids have missions now. At every stop, they're looking for something specific. When they finish enough activities, they bring the booklet back to a ranger, take the Junior Ranger oath, and get a badge. They will care about that badge more than any souvenir in the gift shop.
      </p>
      ...
      <p>
        <strong>Bathrooms and food.</strong> The Village Store has bathrooms, snacks, sandwiches, and overpriced everything. Use the bathrooms now. Buy nothing yet. Your cooler is better than anything in the store. Save the Village Store for the emergency afternoon Popsicle run (you'll need it).
      </p>
      ...
      <p>
        <strong>Cook's Meadow Loop, the one with the views.</strong> Two miles, paved, flat as a parking lot. This is the walk through the heart of the Valley with postcard views of Half Dome, Yosemite Falls, and Sentinel Rock. It connects to Sentinel Bridge, where the famous Half Dome reflection photo is taken. The meadow is gorgeous, the trail is wide, and there's almost no crowd because everyone else went to the waterfalls. <em>(All ages. Strollers: yes. Best in morning or evening light.)</em>
      </p>
      ...
      <p>
        <strong>Bridalveil Fall, the quick hit.</strong> Half a mile round trip from the parking lot. Paved but steep in spots, stroller-difficult on the uphill. The waterfall is one of the most photogenic in the Valley. In spring, the mist at the base is a full-body shower. Short enough that even a reluctant walker can do it. <em>(All ages, but carry small children on the steep section. Best in May to June.)</em>
      </p>
      ...
      <p>I've seen all of these happen to families, most of them more than once.</p>

      <p>
        <strong>Arriving after 10 AM.</strong> You will circle for parking. Your kids will melt down in the back seat. You'll burn an hour of your best daylight on frustration. The fix: leave earlier. Or take YARTS.
      </p>

      <p>
        <strong>Not bringing enough water.</strong> The Valley floor can hit 95°F in July. Kids dehydrate faster than adults and complain about it louder. One liter per person is the minimum for a half-day. Two is better. Bring a water bottle for every person, including the toddler. The only water refill on most Valley trails is the drinking fountain at the Vernal Fall footbridge, a mile from the trailhead.
      </p>

      <p>
        <strong>Skipping sunscreen and hats.</strong> The elevation means more UV. A burned toddler at 2 PM means a screaming toddler at 6 PM. Apply before you leave the car. Reapply at lunch. Hats on everyone.
      </p>

      <p>
        <strong>Ignoring bear rules.</strong> Black bears live in the Valley. They're not aggressive, but they will break into your car for a granola bar. Everything with a scent: food, coolers, sunscreen, lip balm, car seats that smell like crackers, goes in a bear box at your campsite or in your trunk (not the back seat, not the truck bed) when you're in the park. Bear boxes are metal lockers at every campsite and picnic area. Rangers check cars and issue real fines, up to $5,000. Your kids will think the bear box is the coolest thing at the campsite. Let them operate it. But take it seriously.
      </p>
      ...
      <h3>Pack tonight</h3>
      <ul>
        <li>Water bottles for every person (1L minimum each)</li>
        <li>Sunscreen and hats for everyone</li>
        <li>Layers: it's hot at noon, cold at sunset</li>
        <li>Headlamp or flashlight</li>
        <li>Snacks, lunch, and a cooler with ice</li>
        <li>Cash or pass for entrance fee ($35/vehicle or America the Beautiful pass)</li>
        <li><a href="/articles/pack-your-car-for-yosemite">Full car packing list</a></li>
      </ul>

      <h3>First thing in the park</h3>
      <ul>
        <li>Park at Yosemite Village</li>
        <li>Visitor center, then Junior Ranger booklet (free)</li>
        <li>Check ranger program schedule</li>
        <li>Bathrooms at Village Store</li>
      </ul>

      <h3>Best hikes with kids</h3>
      <ul>
        <li>Lower Yosemite Fall: 1 mile, paved, all ages</li>
        <li>Cook's Meadow: 2 miles, paved, all ages</li>
        <li>Mirror Lake: 2 miles, packed dirt, ages 3+</li>
        <li>Bridalveil Fall: 0.5 miles, paved but steep, all ages</li>
      </ul>

      <h3>Swimming</h3>
      <ul>
        <li>Housekeeping Camp: best beach access</li>
        <li>Cascade Picnic Area: quieter, tables, pit toilet</li>
        <li>NOT before mid-July: current is dangerous</li>
      </ul>

      <h3>Bear rules</h3>
      <ul>
        <li>All food and scented items in bear box or car trunk</li>
        <li>Not back seat. Not truck bed. Trunk.</li>
        <li>Rangers check. Fines up to $5,000.</li>
      </ul>

      <h3>Emergency numbers</h3>
      <ul>
        <li>Yosemite dispatch: 209-379-1992</li>
        <li>Yosemite visitor info: 209-372-0200</li>
      </ul>
