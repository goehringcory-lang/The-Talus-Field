...
window.ARTICLE_BODIES["showy-milkweed-yosemite-valley"] = function ShowyMilkweedYosemiteValleyBody() {
  return (
    <>
      <p className="dropcap">
        On the dry, sunny margins of Yosemite Valley right now, in mid-July, a stout gray-green plant is holding up clusters of dusty pink flowers the size of a fist. This is showy milkweed, <em>Asclepias speciosa</em>, and it is having its best two weeks of the year. Walk the edge of El Capitan Meadow or any sun-baked roadside pullout on the Valley floor and you will find it standing three to five feet tall, its stems furred, its broad leaves felted like a rabbit's ear, its flower heads busy with bees, wasps, and, if the summer is kind, monarch butterflies. It is one of the most quietly important plants in the park, and for the next few weeks it is impossible to miss.
      </p>
      ...
      <h2>How to know it when you see it</h2>
      ...
      <p>
        The western monarch, the population that breeds across the Sierra in summer and clusters on the California coast to overwinter, has fallen hard. Overwintering counts that ran into the low millions in the 1980s have dropped to a small fraction of that, and in some recent winters the coastal count has come in below ten thousand butterflies. The reasons are tangled, climate, pesticides, and the loss of the coastal groves among them, but the loss of breeding milkweed across the West is high on every biologist's list. Which is the plain case for the plant on the Valley roadside: a stand of blooming milkweed in July is breeding habitat for an animal that is running out of it.
      </p>

      <h2>The milky sap is the whole strategy</h2>

      <p>
        Snap any part of a showy milkweed and it weeps that thick white latex within seconds. This is the plant's defense, and it is a good one. The latex is sticky enough to gum up the mouthparts of a chewing insect, and it carries the same cardiac glycosides the monarch turns to its own use. Most animals that take a bite learn quickly to leave it alone. Deer avoid it. Cattle avoid it. The plant is, for practical purposes, left standing in landscapes where almost everything else gets grazed, which is part of why you find it thriving on hard, disturbed, sunny ground: roadsides, old pullouts, the dry lower edges of meadows, exactly the places the illustration above calls dry hillsides and roadsides.
      </p>

      <p>
        A handful of specialists have cracked the code. Along with the monarch, milkweed hosts milkweed beetles, milkweed bugs, and tussock moth caterpillars, most of them wearing the same orange-and-black livery, all of them advertising the same borrowed poison. A milkweed plant in full bloom is less a flower than a small, self-defending ecosystem.
      </p>

      <h2>Where and when to see it in the Valley</h2>
      ...
      <p>
        Timing is the point of this piece. The bloom runs from roughly late June through July on the Valley floor, and mid-July is close to its peak. By August the flowers give way to the next act: fat, warty seed pods, the follicles, that split down one side to release hundreds of flat brown seeds, each trailing a tuft of silky white floss called a coma. On a breezy September afternoon the air along the roadsides fills with it. If you would rather track the season as a whole, our <a href="/articles/yosemite-wildflowers-guide">Yosemite wildflower bloom calendar</a> follows the flowers uphill from the canyon floor to the Tuolumne high country as summer climbs the mountain.
      </p>

      <h2>Leave it standing</h2>

      <p>
        The one thing to do with a blooming milkweed is nothing. Do not pick it, and do not dig it up to plant at home; collecting plants is prohibited in the park, and a cut milkweed is a monarch nursery removed from the landscape. If you want milkweed in your own yard, and it is one of the best things a Californian can plant for pollinators, buy nursery stock of a species native to your area rather than taking it from the wild. The latex is also a mild skin and eye irritant, so if you do handle a broken stem, keep it away from your face and wash your hands.
      </p>
