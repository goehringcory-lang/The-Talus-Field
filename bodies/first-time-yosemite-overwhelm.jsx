...
window.ARTICLE_BODIES["first-time-yosemite-overwhelm"] = function FirstTimeYosemiteBody() {
  return (
    <>
      ...
      <p>
        Those places are on every guide for a reason. Tunnel View is the view that helped build the modern conservation movement. El Capitan is roughly three thousand feet of unbroken granite you can stand at the base of and crane your neck back until it hurts. The Mariposa Grove is where giant sequoias have been growing since before the Roman Empire. Cook's Meadow holds one of the most photographed compositions in American landscape photography, and Glacier Point puts you at 7,200 feet looking straight down into the Valley with Half Dome at eye level. Tuolumne Meadows, in late June, will rearrange your sense of what a high-altitude meadow is supposed to look like.
      </p>
      ...
      <blockquote>The bucket list isn't the problem. The strategy is.</blockquote>
      ...
      <ol>
        <li>What season are you actually planning to visit, and do you know what's open and what isn't in that season?</li>
        <li>Among "granite," "waterfalls," "old-growth," "high country," and "wilderness solitude," which two matter most to you? You can have all of them in the same trip. But the order you visit them matters.</li>
        <li>What's your plan if your plan doesn't work?</li>
      </ol>
      ...
      <p>
        The good news is that the work is worth doing. Yosemite is the birthplace of the national park idea, and standing in it (the right way, at the right time) is something I've been trying to explain to people for twenty years and not quite succeeding. The next best thing I can do is help you arrange a trip where you've got a real shot at understanding it on your own.
      </p>
