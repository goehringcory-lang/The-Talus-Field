...
window.ARTICLE_BODIES["yosemite-fire-restrictions-explained"] = function YosemiteFireRestrictionsExplainedBody() {
  return (
    <>
      ...
      <p>
        Yosemite implemented Stage 1 fire restrictions at 12:01 a.m. on Friday, August 7, 2026, parkwide below 8,000 feet in elevation. The park cited hot, dry weather, low fuel moisture, and windy conditions raising the potential for fast wildfire growth, on the recommendation of the Yosemite Fire Program. The restrictions apply <strong>until further notice</strong>, which in practice means until conditions improve enough for the park to lift them, not on a fixed calendar date.
      </p>
      ...
      <p>
        Below 8,000 feet, parkwide: <strong>no building, maintaining, attending, or using a wood or charcoal fire</strong>, including twig stoves, the small backpacking stoves that burn sticks instead of fuel. That covers a campfire at your site, a charcoal grill, a hibachi, anything that burns solid fuel.
      </p>

      <p>
        <strong>Smoking is restricted too.</strong> Below 8,000 feet, smoking is prohibited except inside an enclosed vehicle, inside a campground or picnic area where wood and charcoal fires are otherwise permitted, or in a posted designated smoking area. That is a real change from ordinary conditions, and it catches people who assume the fire rules and the smoking rules are the same thing. They are related, but the smoking rule is broader.
      </p>

      <h2>What still works</h2>

      <p>
        You can still cook, and you can still have light and heat at your site. <strong>Portable stoves</strong> that burn pressurized gas, liquid fuel, or propane are permitted, and so are alcohol stoves, including the small tablet or cube stoves backpackers carry. If your plan for the trip was a camp stove for dinner and a headlamp for light, none of that changes.
      </p>

      <p>
        <strong>Established fire rings in developed areas keep working, with one exception.</strong> Designated frontcountry campgrounds and picnic areas below 8,000 feet are exempt from the wood and charcoal ban, so a ring at Upper Pines or Wawona Campground can still hold a fire. Residential areas in the park's developed communities are exempt too, with one carve-out: in El Portal and Foresta, only charcoal fires are allowed, not wood, because those two communities carry the highest structure-fire exposure in the park. Everywhere else the exemption for residential and developed areas covers both.
      </p>
      ...
      <h2>Two rules, not one, and they are not the same rule</h2>

      <p>
        Even outside fire restrictions, Yosemite Valley and Hodgdon Meadow run a standing seasonal rule: from May through September, wood fires there are allowed only in the evening, roughly 5 to 10 p.m. That rule exists for air quality, not fire danger. The Valley is a granite trough that traps cold air and smoke overnight, and a hundred and fifty morning campfires produce a haze the whole floor has to breathe. <a href="/articles/camping-in-yosemite-first-time">The campground guide</a> covers that rule for a normal summer.
      </p>
      ...
      <p>
        The number itself is not fixed. It reflects that year's conditions and gets set, and can be reset, by the park's fire managers as the season develops. In some past seasons the working elevation line has sat lower, closer to 6,000 feet, when conditions were more severe or a fire was actively burning nearby. In 2026 it is 8,000 feet. The mechanism is what stays constant: check the current line before you assume last year's trip rules still apply.
      </p>

      <h2>How to check before you drive up</h2>

      <p>
        Three places, and check them close to your trip rather than when you booked it, because restrictions can tighten, loosen, or shift elevation with a week's notice.
      </p>

      <p>
        The park's own <strong>fire restrictions page</strong> (nps.gov/yose/planyourvisit/firerestrictions.htm) states whatever is currently in effect, in the same terms used here. The <strong>current conditions page</strong> (nps.gov/yose/planyourvisit/conditions.htm) rolls fire restrictions in with road and trail status, so it is worth a look regardless. And <a href="/now">the Park Bulletin</a> on this site tracks what the current NPS Yosemite Guide edition says is happening, updated roughly every five weeks, alongside the day-to-day alerts that move faster than that. None of these substitute for the others; the fire restrictions page is the one with the actual rule text.
      </p>
      ...
      <p>
        <strong>Backpacking above 8,000 feet.</strong> You can build a fire in an existing ring, below 9,600 feet, if your route takes you that high. Most first and second nights out of trailheads at Tuolumne, Glacier Point Road, or the Valley rim start below that line, so plan on your stove for at least the early part of most routes. <a href="/articles/first-yosemite-backpacking-trip">The backpacking guide</a> covers permits, bear canisters, and the rest of what the paperwork does not tell you.
      </p>

      <p>
        <strong>A day trip with a picnic.</strong> Grills in designated picnic areas are exempt, so a charcoal grill at a developed picnic site still works. A campfire ring you find along a trail or a beach that is not in a designated campground or picnic area does not count as an exemption, restrictions or not.
      </p>

      <p>
        <strong>Smoking anywhere in the park below 8,000 feet.</strong> Car, permitted campground, or posted smoking area. Nowhere else, restrictions or not, and the fine-print addition during restrictions is that "permitted campground" now specifically means one where fires are still allowed under the current rules, which narrows the list.
      </p>
      ...
      <p>
        <a href="/articles/yosemite-during-smoke-season">The smoke season guide</a> covers the second question in full: how to read an AQI number, where in the park the air tends to be cleanest on a bad day, and when to flex your itinerary uphill. This piece only answers the first one. If you are checking one page before a late-summer trip, check both; a clean-air day can still be a no-campfire day, and a smoky day does not excuse a fire that restrictions do not allow.
      </p>
      ...
      <p>
        Restrictions like this one typically go into effect in July, after a stretch of hot, dry weather has pushed fuel moisture down, and they come off when temperatures drop and real rain falls, not on a schedule. Historically, Yosemite has close to a 90 percent chance of a season-ending precipitation event, defined as two or more inches of rain, by October 31. Recent examples: fire restrictions were rescinded in September 2022 after a cooling, wetter pattern moved in, and again in late October 2021 after a combination of rain, snow, and cooler temperatures reduced the danger enough for the park to lift them. Most years land somewhere in that window: sometime after Labor Day, before Halloween, tied to whichever storm actually delivers.
      </p>
      ...
      <ul style={{ fontSize: 14 }}>
        <li><a href="https://www.nps.gov/yose/planyourvisit/firerestrictions.htm" target="_blank" rel="noopener noreferrer">Fire Restrictions, NPS Yosemite</a></li>
        ...
        <li><a href="https://www.nps.gov/yose/blogs/fireinfo.htm" target="_blank" rel="noopener noreferrer">Yosemite Fire Information and Updates, NPS Yosemite</a></li>
      </ul>
    </>
  );
};
