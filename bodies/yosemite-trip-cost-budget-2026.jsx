...
window.ARTICLE_BODIES["yosemite-trip-cost-budget-2026"] = function YosemiteTripCostBudget2026Body() {
  return (
    <>
      ...
      <p>
        If you're entering on foot, bicycle, or horse, the fee is $20 per person. Motorcycles are $30 (valid for up to two motorcycles and four people).
      </p>
      ...
      <p>
        <strong>Camping (cheapest):</strong> $24–$36 per night for a campsite. Valley campgrounds (Upper Pines, Lower Pines, North Pines) are $36. The more remote Tioga Road campgrounds (Tamarack Flat, Yosemite Creek, Porcupine Flat) are $24. Camp 4, the walk-in Valley campground, is $10 per person per night. For a couple, that's $20.
      </p>
      ...
      <p>
        The lodging decision is covered in detail in my <a href="/articles/yosemite-gateway-towns-compared">guide to the gateway towns</a>, but for budgeting purposes: camping saves you hundreds of dollars, and gateway towns save you a hundred or more compared to in-park hotels.
      </p>
      ...
      <p>
        <strong>Camp cooking:</strong> If you're camping or staying somewhere with a kitchen, bringing your own food is the single biggest money-saver on a Yosemite trip. A cooler stocked at a Mariposa or Oakhurst grocery store before you enter the park will cost $15–$25 per person per day for three meals plus snacks. I've seen families of four eat well for a full week on $400 of groceries.
      </p>
      ...
      <p>
        <strong>Day pack:</strong> Something to carry water, snacks, sunscreen, and a layer. A school backpack works. If you want to buy one, $30–$60 gets a perfectly good pack.
      </p>

      <p>
        <strong>Water bottles:</strong> Bring them. The park has water refill stations. Don't buy single-use plastic bottles in the park. It's wasteful and expensive.
      </p>
      ...
      <p>
        Total gear cost for someone starting from scratch: $100–$200 if you're buying shoes and a pack. $0 if you already own reasonable outdoor clothing and a backpack.
      </p>

      <h2>Guided programs and activities</h2>

      <p>
        Yosemite Conservancy runs guided programs in the park, including naturalist walks, stargazing programs, and custom adventures, that range from $15 to several hundred dollars depending on the program type and duration.
      </p>
      ...
      <p>
        <strong>Paid guided programs:</strong> Yosemite Conservancy custom adventures start at $500 for a half-day (up to four people) and $850 for a full day, with $50 per additional person. Multi-day and specialty programs cost more.
      </p>
      ...
      <p>
        Here's what three different four-day, three-night trips look like for two people.
      </p>

      <h3>Shoestring: ~$400–$550 total ($200–$275 per person)</h3>
      ...
      <p>
        <strong>Tips:</strong> Guided programs and sit-down dining. Budget 18–20% on top of listed prices.
      </p>
