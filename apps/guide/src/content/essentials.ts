...
const seed: EssentialInput[] = [
  ...
  },
  {
    ...
    body:
      ...
      '**Shuttle mechanics.** The shuttle runs 7 a.m. to 10 p.m. daily, free, no ticket. Two loops: the Valleywide loop (green) serves every stop about every 22 to 32 minutes, roughly 90 minutes round trip; the East Valley loop (purple) covers the visitor center, Curry Village, and the Happy Isles trailheads about every 18 to 22 minutes, about 50 minutes round trip. Shuttle stop 9 at El Capitan Meadow is temporarily closed. Pets are not allowed on shuttles. The Mariposa Grove runs its own free shuttle from the Welcome Plaza, about every 15 minutes. In 2026 it runs 8 a.m. to 7 p.m. through September 23, 8 a.m. to 5 p.m. from September 24 through October 31, and 8 a.m. to 3:30 p.m. in November if the road stays open.\n\n' +
  ...
  },
  {
    ...
    body:
      ...
      '- **Keep your distance: at least 150 feet (50 yards) from bears and coyotes, and 25 feet from other wildlife.** Approaching or feeding any wildlife, birds and squirrels included, is illegal, not just unwise.\n\n' +
