...
const seed: EssentialInput[] = [
  ...
  },
  {
    ...
    order: 1,
    section: 'plan',
    teaser: 'Which gate you actually want, what entry costs in 2026, and the fact that no timed-entry reservation is required this year.',
    body:
      ...
      'The entrance fee is valid for seven days, and the park does not take cash. A private vehicle is $35 and covers everyone in it. A motorcycle is $30. On foot, a bicycle, or a bus, it is $20 per person age 16 and older, and under 16 is free. Non-U.S. residents age 16 and older pay an additional $100 per person on top of that, unless they hold an annual pass or an America the Beautiful pass. The America the Beautiful annual pass is $80 for U.S. residents and $250 for non-residents, and one pass covers the vehicle. A Yosemite-only annual pass is $70, sold only to U.S. citizens and residents. Fee-free days in 2026 are for U.S. residents only. The table is at **nps.gov/yose/planyourvisit/fees.htm**.\n\n' +
      'No timed-entry reservation is required to enter the park in 2026. The park has used one in recent peak seasons and sets the rule fresh each year, so confirm at **nps.gov/yose** before a trip in a later year. When a reservation system is in effect, two things have generally stayed true: arriving very early or later in the afternoon has been the workaround, and in-park lodging or camping reservations have generally exempted you. Verify both before you rely on them.',
  },
  {
    id: 'getting-around',
    ...
    body:
      ...
      '**Shuttle mechanics.** The shuttle runs 7 a.m. to 10 p.m. daily, free, no ticket. Two loops: the Valleywide loop (green) serves every stop, about an hour and a half round trip; the East Valley loop (purple) covers Yosemite Village, Curry Village, the Pines campgrounds, and the Happy Isles trailheads, about 50 minutes round trip, and comes more often. The park prints different intervals on its website and in the Yosemite Guide, so read the shuttle page of the current Guide for the weeks you are there. Shuttle stop 9 at El Capitan Meadow is temporarily closed. Pets are not allowed on shuttles. The Mariposa Grove runs its own free shuttle from the Welcome Plaza, about every 15 minutes. In 2026 it runs 8 a.m. to 7 p.m. through September 23, 8 a.m. to 5 p.m. from September 24 through October 31, and 8 a.m. to 3:30 p.m. in November if the road stays open.\n\n' +
  ...
  },
  {
    ...
    body:
      'Whether the park meters entry with a reservation system changes year to year. It does not in 2026. Check nps.gov/yose before you book a later year. What does not change is the shape of the demand, and that shape is the thing to plan around.\n\n' +
...

  {
    ...
    body:
      'The park is blunt about it: water-related accidents are the second most common cause of death in Yosemite, and 15 to 20 visitor rescues a year begin with someone in the water, on purpose or after one misstep on a rock beside it. The danger is almost never swimming skill. It is cold and current.\n\n' +
      ...
      '**The season.** River swimming is a late-summer thing. In May and June the Merced runs fast and dangerously cold, and the park says to swim only in low water and to stay out of whitewater. The Valley beach season is roughly mid-July into September, as the [Heat](/essentials/heat-safety) topic has it, but the changeover follows the snowpack, not a date: look at the water, not the calendar. Enter and leave the Merced only at sandy beaches, which protects the banks.\n\n' +
      ...
      '**Where swimming is illegal.** These are closures, not advice: Emerald Pool and the Silver Apron down to the brink of Vernal Fall; Hetch Hetchy Reservoir and the first mile of any stream flowing into it, [Rancheria Falls](/stop/rancheria-falls) included; Lake Eleanor when posted; the Dana Fork of the Tuolumne above the water intake; the Wawona water intake pool and 100 yards above it; and May Lake near the High Sierra Camp\'s water intake. If a sign says no swimming, the park means no wading either.\n\n' +
  ...
  },
  {
    ...
    body:
      'Two errands at the gate make the rest of the trip easier, and both are free.\n\n' +
      ...
      '**Where the grades work.** The east side of the [Lower Yosemite Fall](/stop/lower-yosemite-fall) loop is wheelchair accessible all the way to the viewing area; the west side is mostly accessible, but its last 180 feet climb at 13.8 percent. [Cook\'s Meadow](/stop/cooks-meadow-loop) is flat pavement and boardwalk. The road to [Mirror Lake](/stop/mirror-lake) is a paved mile from the shuttle stop, and its last 1,000 feet run 6.6 to 10.6 percent; with a placard you can drive it. At the [Mariposa Grove](/stop/mariposa-grove) the Big Trees Loop is a flat 0.3 mile and wheelchair accessible, and placard holders may drive on past the arrival area to a small lot near the Grizzly Giant, seven accessible spaces, then walk 0.1 mile on compressed dirt to the Grizzly Giant and the California Tunnel Tree. At [Glacier Point](/stop/glacier-point) both paved paths to the overlook are steeper than an accessible grade in places; the restrooms and snack bar are accessible. Up Tioga Road, [Olmsted Point](/stop/olmsted-point) has a fully accessible viewing area with a bronze tactile map of Half Dome.\n\n' +
  ...
  },
  {
    ...
    body:
      ...
      'Three things catch people at the trailhead. Carrying the dog changes nothing: the park makes no exception for a pet in your arms, a carrier, a stroller, or a backpack. [Dog Lake](/hike/dog-lake) is a name, not an invitation; the park says in as many words that pets are not allowed there. And the trail rule is neither new nor temporary. The Park Service has kept pets off trails for many years, for the sake of the pets and the wildlife both.\n\n' +
      ...
      'The trip that suits a dog: the Valley\'s paved paths, a Wawona meadow walk, a campsite at the Pines or Wawona. The trip that does not: anything with a trail, a sequoia grove, or the Mist Trail at its center. Any visitor center hands out a B.A.R.K. Ranger pledge card if the dog wants a credential of its own.',
    checklist: [
  ...
  },
  {
    ...
    body:
      'Yosemite has 13 campgrounds, and from April through October all of them run on reservations. The park\'s advice is blunt: do not arrive in that season without one, because no first-come campground is open and you will probably have to leave the park to sleep. Sleeping in a vehicle is legal only in a campsite you have registered for; not in a turnout, not in a trailhead lot.\n\n' +
      ...
      '**What a site gives you.** Room for six people and two vehicles; a trailer that fits on the parking pad does not count as a vehicle. Most campgrounds charge $36 a night and the primitive ones less, as [What a trip costs](/essentials/budget) sets out. There are no hookups anywhere in the park. The dump station at Upper Pines runs all year, with summer stations near Wawona and Tuolumne Meadows when they are operating. The only showers in the park are at the Curry Village pool showerhouse, for a fee. At Tamarack Flat, Yosemite Creek, and Porcupine Flat, creek water must be boiled. The Valley has only eight sites that take a 40-foot RV or a 35-foot trailer, and two roads draw a hard line: 30 feet and no trailers past the Sentinel Dome and Taft Point trailhead on Glacier Point Road, and 25 feet long and 8 feet wide, mirror to mirror, on the road to [Hetch Hetchy](/essentials/hetch-hetchy).\n\n' +
      '**The clock.** Check-in and checkout are noon. Arrive as late as you like, but check in before 10 a.m. the morning after your first night or the reservation is cancelled. Quiet hours run 10 p.m. to 6 a.m.; generators run only 7 to 9 a.m., noon to 2 p.m., and 5 to 7 p.m. From May through September, wood fires in the Valley campgrounds and Hodgdon Meadow burn only from 5 to 10 p.m., and summer fire restrictions can go further, so check the current stage; stoves are allowed at any hour. Do not bring firewood from more than 50 miles away; stores near most campgrounds sell it. Between May 1 and September 15 each person may camp 14 nights in the park, only seven of them in the Valley or Wawona.\n\n' +
  ...
  },
  {
    ...
    body:
      'Heat gets the attention because the Valley is where most visitors spend their day. The high country runs the other way, and three hazards there take people by surprise: lightning, thin air, and cold.\n\n' +
      ...
      'If you hear thunder, the storm is within about 10 miles; do not wait for it to come closer. There is no safe shelter outside. The only safe places are a substantial building or a hard-topped vehicle. If you are caught out, get down off peaks, ridges, and viewpoints. Stay away from lone tall trees, water, and metal, and avoid shuttle stops, vault toilets, and open vehicles such as the tram. Spread the group at least 50 feet apart, so one strike cannot take everyone. In forest, get under the shortest trees you can find. As a last resort, crouch on your toes with your hands over your ears, touching the ground as little as possible, and do not lie flat. Wait 30 minutes after the last thunder. A lightning victim is safe to touch: start CPR if you are trained, and call 911.\n\n' +
      '**Altitude.** Tioga Road tops out at 9,945 feet at the pass, Tuolumne Meadows sits at 8,600, and Glacier Point at about 7,200. At or above 8,000 feet many people feel it as fatigue or a headache, and a few visitors every summer develop altitude sickness: a severe headache, nausea. The park is plain about the treatment. The only relief is to descend, immediately. Drink water and eat salty snacks on the way up.\n\n' +
      '**Cold.** The July day that averages a high of 89°F in the Valley averages a low of 39°F in Tuolumne Meadows, and the June and September lows there sit at freezing. Snow can fall in the high country in any month. Wet cotton on a windy ridge is how a day hike becomes hypothermia, and snowmelt water finishes the job fast; see [Rivers and waterfalls](/essentials/water-safety). The park asks every hiker to carry extra food and water, rain gear, and warm clothing in case of a night out that was never planned. [The day pack](/essentials/day-pack) list covers it.\n\n' +
      '**Rockfall and trees.** The Valley walls shed rock: more than 1,000 rockfalls are on record in the past 150 years, and the talus piles at the base of every cliff are the evidence. If you see one from the Valley floor, move away from the cliff toward the center of the Valley. If you are at the foot of a cliff or a talus slope when rock comes down, get behind the largest boulder near you, then move away once it stops. Stay off closed trails. Report any rockfall you see or hear to 209/379-1420. Trees fail too, some with no visible defect, and several have seriously or fatally injured visitors here, so stay aware of what is overhead, especially away from developed areas.\n\n' +
  ...
  },
  {
    ...
    body:
      ...
      '**Chains, in plain terms.** When a chain control sign is up, federal rules inside the park and state law outside it require chains or cables, strictly enforced. Expect controls November through March, less often in October and April, rarely in September or May. They come most often on the Wawona Road (Highway 41), the Big Oak Flat Road (Highway 120 from the west), and the road to Badger Pass; least often on the El Portal Road (Highway 140), the Valley floor, and the Hetch Hetchy Road. Whenever controls are on, every vehicle must carry chains, four-wheel drive and rentals included. Cables and tire socks meet the law; plastic straps and other emergency devices do not. The signs come in three levels:\n\n' +
      ...
      '**The routes.** Marked winter routes usually hold enough snow from mid-to-late December through mid-March. Past Badger Pass, Glacier Point Road is closed to cars and groomed: snowshoers keep to the edges, outside the classic ski tracks, and there is a pit toilet at Summit Meadow about a mile out. The ungroomed route to [Dewey Point](/hike/dewey-point) is the classic trip to the rim. Near [Crane Flat](/stop/crane-flat-meadow), ungroomed routes start around 6,200 feet at the Tuolumne and Merced Grove lots: Crane Flat Lookout is 1.5 miles one way, the Gin Flat Loop 6.25 miles round trip, and a snow play area takes the sleds. The [Mariposa Grove](/stop/mariposa-grove) shuttle does not run from December 1 until at least mid-April, so the grove is then two miles each way and about 500 feet of climb on the Washburn Trail or the closed road, often snowy or icy. Markers on trees can be buried, and old tracks may not go where you are going.\n\n' +
  ...
  },
  {
    ...
    body:
      'Most of what the park asks of visitors is courtesy. The rules below are not. They are federal regulations, set out in the Code of Federal Regulations and in the Superintendent\'s Compendium the park reissues each year, and rangers write citations for them. Nearly everyone who breaks one does it without knowing.\n\n' +
      ...
      '**Taking things home.** Collecting plants is illegal, and the park names pine cones specifically. So is collecting reptiles or butterflies, picking up an arrowhead or any historic object, and possessing a metal detector. Take photographs.\n\n' +
  ...
  },
  {
    ...
    body:
      ...
      '**Where you may sleep.** Camp at least four trail miles from Yosemite Valley, Tuolumne Meadows, Glacier Point, Hetch Hetchy, and Wawona, and at least a mile from any road. Every camp sits at least 100 feet from water and from the trail, on an established site and a durable surface, never in a meadow. Camping is banned at Lukens Lake, in the Lost Lake basin, on top of Half Dome, and in the watersheds of the Dana Fork of the Tuolumne, Parker Pass Creek, Gaylor Creek, Elizabeth Creek, and Budd Creek. On the climb from Happy Isles, the Little Yosemite Valley campground is the only legal camp short of the Half Dome and Sunrise Creek trail junctions, and within a mile of a High Sierra Camp you use its campground. Groups top out at 15 people, or 8 for travel more than a quarter mile off trail.\n\n' +
...
export const ESSENTIALS_META = {
  ...
  teaser:
    'Entrances, crowds, budgets, camping and wilderness permits, accessibility, dogs, winter, bears, water, weather, the rules that carry fines, and the packing checklists. The logistics layer under the whole trip.',
}
