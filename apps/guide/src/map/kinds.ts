...
// StopKind; day-hike trailheads are their own kind — a hike is a route, not a
// Stop, but on the map it earns the same first-class treatment (chip, count,
// legend) as any stop kind.
export type MapPinKind = StopKind | 'hike'
