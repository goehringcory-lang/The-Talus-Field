...
export default function Map() {
  ...
  // mappableStops) because a row pointing at a filtered-out marker would
  // select nothing and silently close any open popup.
  ...
  // The points pane is now only "Near you", so it has nothing to say until
  // there is a location fix (or a denial to explain). Rendering it empty would
  // leave a blank card on desktop and a dead handle docked over the map on
  // phones, so it drops out entirely instead.
              ...
              <div className="map-pane__scroll">
                ...
                {nearbyStops.length > 0 && (
                  <div className="map-nearby">
                    <h3 className="map-pane__title map-pane__title--nearby">Near you</h3>
                    {outOfPark && (
                      <p className="map-nearby__note">
